...
if ((c != NULL) && (c[0] != '\0')) { PyErr_SetString(PyExc_RuntimeError, c); \
    error_destruct(error); return NULL; } error_destruct(error); \
...
newXxoObject(PyObject *arg)
{
    ...
    PyDict_SetItemString(attr_dict, "group", PyUnicode_FromString("PowerPlant"));
    PyDict_SetItemString(attr_dict, "technology", PyUnicode_FromString("GenericSytem"));
...
static PyObject *
Xxo_set_derate(XxoObject *self, PyObject *args)
{
    float derate;
    SAM_error error = new_error();
...
static PyObject *
Xxo_get_derate(XxoObject *self, PyObject *args)
{
    double derate;
    SAM_error error = new_error();
...
static PyMethodDef Xxo_methods[] = {
        {"set_derate",            (PyCFunction)Xxo_set_derate,  METH_VARARGS,
                PyDoc_STR("set_derate() -> None\n Derate [%]")},
        {"get_derate",            (PyCFunction)Xxo_get_derate,  METH_VARARGS,
