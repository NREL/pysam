...
AdjustmentFactors_export(AdjustmentFactorsObject *self, PyObject *args)
{
    ...
    PyObject* dict = PySAM_export_to_dict(self->data_ptr, (PyObject *) self, tp, "AdjustmentFactors", "AdjustmentFactors");
    return dict;
}
...
static PyObject *
AdjustmentFactors_get_ac_constant(AdjustmentFactorsObject *self, void *closure)
{
    PySAM_FLOAT_GETTER(SAM_AdjustmentFactors_adjust_constant_fget)
}

static int
AdjustmentFactors_set_ac_constant(AdjustmentFactorsObject *self, PyObject *value, void *closure)
{
    PySAM_FLOAT_SETTER(SAM_AdjustmentFactors_adjust_constant_fset)
}

static PyObject *
AdjustmentFactors_get_ac_hourly(AdjustmentFactorsObject *self, void *closure)
{
    return PySAM_array_getter(SAM_AdjustmentFactors_adjust_hourly_aget, self->data_ptr);
}

static int
AdjustmentFactors_set_ac_hourly(AdjustmentFactorsObject *self, PyObject *value, void *closure)
{
    return PySAM_array_setter(value, SAM_AdjustmentFactors_adjust_hourly_aset, self->data_ptr);
}

static PyObject *
AdjustmentFactors_get_ac_periods(AdjustmentFactorsObject *self, void *closure)
{
    return PySAM_matrix_getter(SAM_AdjustmentFactors_adjust_periods_mget, self->data_ptr);
}

static int
AdjustmentFactors_set_ac_periods(AdjustmentFactorsObject *self, PyObject *value, void *closure)
{
...
{
    PySAM_FLOAT_GETTER(SAM_AdjustmentFactors_dc_adjust_constant_fget)
}

static int
AdjustmentFactors_set_dc_constant(AdjustmentFactorsObject *self, PyObject *value, void *closure)
{
    PySAM_FLOAT_SETTER(SAM_AdjustmentFactors_dc_adjust_constant_fset)
}
...
{
    PySAM_FLOAT_GETTER(SAM_AdjustmentFactors_sf_adjust_constant_fget)
}

static int
AdjustmentFactors_set_sf_constant(AdjustmentFactorsObject *self, PyObject *value, void *closure)
{
    PySAM_FLOAT_SETTER(SAM_AdjustmentFactors_sf_adjust_constant_fset)
}
...
static PyGetSetDef AdjustmentFactors_getset[] = {
        {"ac_constant", (getter)AdjustmentFactors_get_ac_constant, (setter)AdjustmentFactors_set_ac_constant,
                "AC Constant loss adjustment [%]", NULL},
        {"ac_hourly", (getter)AdjustmentFactors_get_ac_hourly, (setter)AdjustmentFactors_set_ac_hourly,
                "AC Hourly Adjustment Factors [%]", NULL},
        {"ac_periods", (getter)AdjustmentFactors_get_ac_periods, (setter)AdjustmentFactors_set_ac_periods,
