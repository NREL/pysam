...
static PyTypeObject TcstroughEmpirical_Type = {
		...
		0,                          /*tp_as_buffer*/
		Py_TPFLAGS_DEFAULT,         /*tp_flags*/
		"Wrapper for `cmod_tcstrough_empirical.cpp <https://github.com/NREL/ssc/blob/develop/ssc/cmod_tcstrough_empirical.cpp>`_",        /*tp_doc*/
		0,                          /*tp_traverse*/
		0,                          /*tp_clear*/
		0,                          /*tp_richcompare*/
		0,                          /*tp_weaklistofnset*/
...
static PyMethodDef TcstroughEmpiricalModule_methods[] = {
		...
		{"default",             TcstroughEmpirical_default,         METH_VARARGS,
				PyDoc_STR("default(config) -> new TcstroughEmpirical object with financial model-specific default attributes\n"
