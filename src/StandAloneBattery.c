...
static PyObject *
TimeOfDelivery_new(SAM_Battery data_ptr)
{
...
TimeOfDelivery_assign(TimeOfDeliveryObject *self, PyObject *args)
{
	...
	if (!PySAM_assign_from_dict(self->data_ptr, dict, "Battery", "TimeOfDelivery")){
		return NULL;
	}
...
{
	return PySAM_array_getter(SAM_Battery_TimeOfDelivery_dispatch_factors_ts_aget, self->data_ptr);
}

static int
TimeOfDelivery_set_dispatch_factors_ts(TimeOfDeliveryObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_Battery_TimeOfDelivery_dispatch_factors_ts_aset, self->data_ptr);
}

static PyObject *
TimeOfDelivery_get_dispatch_sched_weekday(TimeOfDeliveryObject *self, void *closure)
{
	return PySAM_matrix_getter(SAM_Battery_TimeOfDelivery_dispatch_sched_weekday_mget, self->data_ptr);
}

static int
TimeOfDelivery_set_dispatch_sched_weekday(TimeOfDeliveryObject *self, PyObject *value, void *closure)
{
		return PySAM_matrix_setter(value, SAM_Battery_TimeOfDelivery_dispatch_sched_weekday_mset, self->data_ptr);
}

static PyObject *
TimeOfDelivery_get_dispatch_sched_weekend(TimeOfDeliveryObject *self, void *closure)
{
	return PySAM_matrix_getter(SAM_Battery_TimeOfDelivery_dispatch_sched_weekend_mget, self->data_ptr);
}

static int
TimeOfDelivery_set_dispatch_sched_weekend(TimeOfDeliveryObject *self, PyObject *value, void *closure)
{
		return PySAM_matrix_setter(value, SAM_Battery_TimeOfDelivery_dispatch_sched_weekend_mset, self->data_ptr);
}

static PyObject *
TimeOfDelivery_get_dispatch_tod_factors(TimeOfDeliveryObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Battery_TimeOfDelivery_dispatch_tod_factors_aget, self->data_ptr);
}

static int
TimeOfDelivery_set_dispatch_tod_factors(TimeOfDeliveryObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_Battery_TimeOfDelivery_dispatch_tod_factors_aset, self->data_ptr);
}

static PyObject *
TimeOfDelivery_get_ppa_multiplier_model(TimeOfDeliveryObject *self, void *closure)
{
	return PySAM_double_getter(SAM_Battery_TimeOfDelivery_ppa_multiplier_model_nget, self->data_ptr);
}

static int
TimeOfDelivery_set_ppa_multiplier_model(TimeOfDeliveryObject *self, PyObject *value, void *closure)
{
	return PySAM_double_setter(value, SAM_Battery_TimeOfDelivery_ppa_multiplier_model_nset, self->data_ptr);
}

static PyObject *
TimeOfDelivery_get_ppa_price_input(TimeOfDeliveryObject *self, void *closure)
{
	return PySAM_double_getter(SAM_Battery_TimeOfDelivery_ppa_price_input_nget, self->data_ptr);
}

static int
TimeOfDelivery_set_ppa_price_input(TimeOfDeliveryObject *self, PyObject *value, void *closure)
{
	return PySAM_double_setter(value, SAM_Battery_TimeOfDelivery_ppa_price_input_nset, self->data_ptr);
}
...
static PyTypeObject TimeOfDelivery_Type = {
		 ...
		 * to be portable to Windows without using C++. */
		PyVarObject_HEAD_INIT(NULL, 0)
		"StandAloneBattery.TimeOfDelivery",             /*tp_name*/
...
StandAloneBatteryModule_exec(PyObject *m)
{
	...
	/// Add the TimeOfDelivery type object to StandAloneBattery_Type
