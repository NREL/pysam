...
static PyTypeObject Singleowner_Type = {
		...
		0,                          /*tp_as_buffer*/
		Py_TPFLAGS_DEFAULT,         /*tp_flags*/
		"Wrapper for `cmod_singleowner.cpp <https://github.com/NREL/ssc/blob/develop/ssc/cmod_singleowner.cpp>`_",        /*tp_doc*/
		0,                          /*tp_traverse*/
		0,                          /*tp_clear*/
		0,                          /*tp_richcompare*/
		0,                          /*tp_weaklistofnset*/
...
static PyMethodDef SingleownerModule_methods[] = {
		...
		{"default",             Singleowner_default,         METH_VARARGS,
				PyDoc_STR("default(config) -> new Singleowner object with financial model-specific default attributes\n"
