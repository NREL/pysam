...
static PyMethodDef LevpartflipModule_methods[] = {
		...
		{"default",             Levpartflip_default,         METH_VARARGS,
				...
				"Options: TcsMSLF, TcsdirectSteam, TcslinearFresnel, Geothermal, TcsgenericSolar, Hcpv, GenericSystem, Windpower, Tcsdish, Pvwattsv5, Pvsamv1, TcsmoltenSalt, Biomass, TcstroughEmpirical, TcstroughPhysical")},
