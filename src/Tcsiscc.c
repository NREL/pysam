...
static PyTypeObject Tcsiscc_Type = {
		...
		0,                          /*tp_as_buffer*/
		Py_TPFLAGS_DEFAULT,         /*tp_flags*/
		"Wrapper for `cmod_tcsiscc.cpp <https://github.com/NREL/ssc/blob/develop/ssc/cmod_tcsiscc.cpp>`_",        /*tp_doc*/
		0,                          /*tp_traverse*/
		0,                          /*tp_clear*/
		0,                          /*tp_richcompare*/
		0,                          /*tp_weaklistofnset*/
...
static PyMethodDef TcsisccModule_methods[] = {
		...
		{"default",             Tcsiscc_default,         METH_VARARGS,
				PyDoc_STR("default(config) -> new Tcsiscc object with financial model-specific default attributes\n"
				"config options:\n\n- \"ISCCSingleOwner\"")},
