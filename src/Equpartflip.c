...
{
	return PySAM_float_getter(SAM_Equpartflip_FinancialParameters_analysis_period_fget, self->data_ptr);
}

static int
FinancialParameters_set_analysis_period(FinancialParametersObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_FinancialParameters_analysis_period_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_FinancialParameters_inflation_rate_fget, self->data_ptr);
}

static int
FinancialParameters_set_inflation_rate(FinancialParametersObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_FinancialParameters_inflation_rate_fset, self->data_ptr);
}

static PyObject *
FinancialParameters_get_insurance_rate(FinancialParametersObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_FinancialParameters_insurance_rate_fget, self->data_ptr);
}

static int
FinancialParameters_set_insurance_rate(FinancialParametersObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_FinancialParameters_insurance_rate_fset, self->data_ptr);
}

static PyObject *
FinancialParameters_get_prop_tax_assessed_decline(FinancialParametersObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_FinancialParameters_prop_tax_assessed_decline_fget, self->data_ptr);
}

static int
FinancialParameters_set_prop_tax_assessed_decline(FinancialParametersObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_FinancialParameters_prop_tax_assessed_decline_fset, self->data_ptr);
}

static PyObject *
FinancialParameters_get_prop_tax_cost_assessed_percent(FinancialParametersObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_FinancialParameters_prop_tax_cost_assessed_percent_fget, self->data_ptr);
}

static int
FinancialParameters_set_prop_tax_cost_assessed_percent(FinancialParametersObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_FinancialParameters_prop_tax_cost_assessed_percent_fset, self->data_ptr);
}

static PyObject *
FinancialParameters_get_property_tax_rate(FinancialParametersObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_FinancialParameters_property_tax_rate_fget, self->data_ptr);
}

static int
FinancialParameters_set_property_tax_rate(FinancialParametersObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_FinancialParameters_property_tax_rate_fset, self->data_ptr);
}

static PyObject *
FinancialParameters_get_real_discount_rate(FinancialParametersObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_FinancialParameters_real_discount_rate_fget, self->data_ptr);
}

static int
FinancialParameters_set_real_discount_rate(FinancialParametersObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_FinancialParameters_real_discount_rate_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_FinancialParameters_system_capacity_fget, self->data_ptr);
}

static int
FinancialParameters_set_system_capacity(FinancialParametersObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_FinancialParameters_system_capacity_fset, self->data_ptr);
}

static PyObject *
FinancialParameters_get_system_heat_rate(FinancialParametersObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_FinancialParameters_system_heat_rate_fget, self->data_ptr);
}

static int
FinancialParameters_set_system_heat_rate(FinancialParametersObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_FinancialParameters_system_heat_rate_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_SystemCosts_add_om_num_types_fget, self->data_ptr);
}

static int
SystemCosts_set_add_om_num_types(SystemCostsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_SystemCosts_add_om_num_types_fset, self->data_ptr);
}

static PyObject *
SystemCosts_get_annual_fuel_usage(SystemCostsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_SystemCosts_annual_fuel_usage_fget, self->data_ptr);
}

static int
SystemCosts_set_annual_fuel_usage(SystemCostsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_SystemCosts_annual_fuel_usage_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_SystemCosts_om_capacity1_nameplate_fget, self->data_ptr);
}

static int
SystemCosts_set_om_capacity1_nameplate(SystemCostsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_SystemCosts_om_capacity1_nameplate_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_SystemCosts_om_capacity2_nameplate_fget, self->data_ptr);
}

static int
SystemCosts_set_om_capacity2_nameplate(SystemCostsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_SystemCosts_om_capacity2_nameplate_fset, self->data_ptr);
}

static PyObject *
SystemCosts_get_om_capacity_escal(SystemCostsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_SystemCosts_om_capacity_escal_fget, self->data_ptr);
}

static int
SystemCosts_set_om_capacity_escal(SystemCostsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_SystemCosts_om_capacity_escal_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_SystemCosts_om_fixed_escal_fget, self->data_ptr);
}

static int
SystemCosts_set_om_fixed_escal(SystemCostsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_SystemCosts_om_fixed_escal_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_SystemCosts_om_fuel_cost_escal_fget, self->data_ptr);
}

static int
SystemCosts_set_om_fuel_cost_escal(SystemCostsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_SystemCosts_om_fuel_cost_escal_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_SystemCosts_om_opt_fuel_1_cost_escal_fget, self->data_ptr);
}

static int
SystemCosts_set_om_opt_fuel_1_cost_escal(SystemCostsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_SystemCosts_om_opt_fuel_1_cost_escal_fset, self->data_ptr);
}

static PyObject *
SystemCosts_get_om_opt_fuel_1_usage(SystemCostsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_SystemCosts_om_opt_fuel_1_usage_fget, self->data_ptr);
}

static int
SystemCosts_set_om_opt_fuel_1_usage(SystemCostsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_SystemCosts_om_opt_fuel_1_usage_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_SystemCosts_om_opt_fuel_2_cost_escal_fget, self->data_ptr);
}

static int
SystemCosts_set_om_opt_fuel_2_cost_escal(SystemCostsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_SystemCosts_om_opt_fuel_2_cost_escal_fset, self->data_ptr);
}

static PyObject *
SystemCosts_get_om_opt_fuel_2_usage(SystemCostsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_SystemCosts_om_opt_fuel_2_usage_fget, self->data_ptr);
}

static int
SystemCosts_set_om_opt_fuel_2_usage(SystemCostsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_SystemCosts_om_opt_fuel_2_usage_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_SystemCosts_om_production_escal_fget, self->data_ptr);
}

static int
SystemCosts_set_om_production_escal(SystemCostsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_SystemCosts_om_production_escal_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_SystemCosts_om_replacement_cost_escal_fget, self->data_ptr);
}

static int
SystemCosts_set_om_replacement_cost_escal(SystemCostsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_SystemCosts_om_replacement_cost_escal_fset, self->data_ptr);
}

static PyObject *
SystemCosts_get_total_installed_cost(SystemCostsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_SystemCosts_total_installed_cost_fget, self->data_ptr);
}

static int
SystemCosts_set_total_installed_cost(SystemCostsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_SystemCosts_total_installed_cost_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_TaxCreditIncentives_itc_fed_amount_fget, self->data_ptr);
}

static int
TaxCreditIncentives_set_itc_fed_amount(TaxCreditIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TaxCreditIncentives_itc_fed_amount_fset, self->data_ptr);
}

static PyObject *
TaxCreditIncentives_get_itc_fed_amount_deprbas_fed(TaxCreditIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_TaxCreditIncentives_itc_fed_amount_deprbas_fed_fget, self->data_ptr);
}

static int
TaxCreditIncentives_set_itc_fed_amount_deprbas_fed(TaxCreditIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TaxCreditIncentives_itc_fed_amount_deprbas_fed_fset, self->data_ptr);
}

static PyObject *
TaxCreditIncentives_get_itc_fed_amount_deprbas_sta(TaxCreditIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_TaxCreditIncentives_itc_fed_amount_deprbas_sta_fget, self->data_ptr);
}

static int
TaxCreditIncentives_set_itc_fed_amount_deprbas_sta(TaxCreditIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TaxCreditIncentives_itc_fed_amount_deprbas_sta_fset, self->data_ptr);
}

static PyObject *
TaxCreditIncentives_get_itc_fed_percent(TaxCreditIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_TaxCreditIncentives_itc_fed_percent_fget, self->data_ptr);
}

static int
TaxCreditIncentives_set_itc_fed_percent(TaxCreditIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TaxCreditIncentives_itc_fed_percent_fset, self->data_ptr);
}

static PyObject *
TaxCreditIncentives_get_itc_fed_percent_deprbas_fed(TaxCreditIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_TaxCreditIncentives_itc_fed_percent_deprbas_fed_fget, self->data_ptr);
}

static int
TaxCreditIncentives_set_itc_fed_percent_deprbas_fed(TaxCreditIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TaxCreditIncentives_itc_fed_percent_deprbas_fed_fset, self->data_ptr);
}

static PyObject *
TaxCreditIncentives_get_itc_fed_percent_deprbas_sta(TaxCreditIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_TaxCreditIncentives_itc_fed_percent_deprbas_sta_fget, self->data_ptr);
}

static int
TaxCreditIncentives_set_itc_fed_percent_deprbas_sta(TaxCreditIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TaxCreditIncentives_itc_fed_percent_deprbas_sta_fset, self->data_ptr);
}

static PyObject *
TaxCreditIncentives_get_itc_fed_percent_maxvalue(TaxCreditIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_TaxCreditIncentives_itc_fed_percent_maxvalue_fget, self->data_ptr);
}

static int
TaxCreditIncentives_set_itc_fed_percent_maxvalue(TaxCreditIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TaxCreditIncentives_itc_fed_percent_maxvalue_fset, self->data_ptr);
}

static PyObject *
TaxCreditIncentives_get_itc_sta_amount(TaxCreditIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_TaxCreditIncentives_itc_sta_amount_fget, self->data_ptr);
}

static int
TaxCreditIncentives_set_itc_sta_amount(TaxCreditIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TaxCreditIncentives_itc_sta_amount_fset, self->data_ptr);
}

static PyObject *
TaxCreditIncentives_get_itc_sta_amount_deprbas_fed(TaxCreditIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_TaxCreditIncentives_itc_sta_amount_deprbas_fed_fget, self->data_ptr);
}

static int
TaxCreditIncentives_set_itc_sta_amount_deprbas_fed(TaxCreditIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TaxCreditIncentives_itc_sta_amount_deprbas_fed_fset, self->data_ptr);
}

static PyObject *
TaxCreditIncentives_get_itc_sta_amount_deprbas_sta(TaxCreditIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_TaxCreditIncentives_itc_sta_amount_deprbas_sta_fget, self->data_ptr);
}

static int
TaxCreditIncentives_set_itc_sta_amount_deprbas_sta(TaxCreditIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TaxCreditIncentives_itc_sta_amount_deprbas_sta_fset, self->data_ptr);
}

static PyObject *
TaxCreditIncentives_get_itc_sta_percent(TaxCreditIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_TaxCreditIncentives_itc_sta_percent_fget, self->data_ptr);
}

static int
TaxCreditIncentives_set_itc_sta_percent(TaxCreditIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TaxCreditIncentives_itc_sta_percent_fset, self->data_ptr);
}

static PyObject *
TaxCreditIncentives_get_itc_sta_percent_deprbas_fed(TaxCreditIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_TaxCreditIncentives_itc_sta_percent_deprbas_fed_fget, self->data_ptr);
}

static int
TaxCreditIncentives_set_itc_sta_percent_deprbas_fed(TaxCreditIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TaxCreditIncentives_itc_sta_percent_deprbas_fed_fset, self->data_ptr);
}

static PyObject *
TaxCreditIncentives_get_itc_sta_percent_deprbas_sta(TaxCreditIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_TaxCreditIncentives_itc_sta_percent_deprbas_sta_fget, self->data_ptr);
}

static int
TaxCreditIncentives_set_itc_sta_percent_deprbas_sta(TaxCreditIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TaxCreditIncentives_itc_sta_percent_deprbas_sta_fset, self->data_ptr);
}

static PyObject *
TaxCreditIncentives_get_itc_sta_percent_maxvalue(TaxCreditIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_TaxCreditIncentives_itc_sta_percent_maxvalue_fget, self->data_ptr);
}

static int
TaxCreditIncentives_set_itc_sta_percent_maxvalue(TaxCreditIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TaxCreditIncentives_itc_sta_percent_maxvalue_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_TaxCreditIncentives_ptc_fed_escal_fget, self->data_ptr);
}

static int
TaxCreditIncentives_set_ptc_fed_escal(TaxCreditIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TaxCreditIncentives_ptc_fed_escal_fset, self->data_ptr);
}

static PyObject *
TaxCreditIncentives_get_ptc_fed_term(TaxCreditIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_TaxCreditIncentives_ptc_fed_term_fget, self->data_ptr);
}

static int
TaxCreditIncentives_set_ptc_fed_term(TaxCreditIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TaxCreditIncentives_ptc_fed_term_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_TaxCreditIncentives_ptc_sta_escal_fget, self->data_ptr);
}

static int
TaxCreditIncentives_set_ptc_sta_escal(TaxCreditIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TaxCreditIncentives_ptc_sta_escal_fset, self->data_ptr);
}

static PyObject *
TaxCreditIncentives_get_ptc_sta_term(TaxCreditIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_TaxCreditIncentives_ptc_sta_term_fget, self->data_ptr);
}

static int
TaxCreditIncentives_set_ptc_sta_term(TaxCreditIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TaxCreditIncentives_ptc_sta_term_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_cbi_fed_amount_fget, self->data_ptr);
}

static int
PaymentIncentives_set_cbi_fed_amount(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_cbi_fed_amount_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_cbi_fed_deprbas_fed(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_cbi_fed_deprbas_fed_fget, self->data_ptr);
}

static int
PaymentIncentives_set_cbi_fed_deprbas_fed(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_cbi_fed_deprbas_fed_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_cbi_fed_deprbas_sta(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_cbi_fed_deprbas_sta_fget, self->data_ptr);
}

static int
PaymentIncentives_set_cbi_fed_deprbas_sta(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_cbi_fed_deprbas_sta_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_cbi_fed_maxvalue(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_cbi_fed_maxvalue_fget, self->data_ptr);
}

static int
PaymentIncentives_set_cbi_fed_maxvalue(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_cbi_fed_maxvalue_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_cbi_fed_tax_fed(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_cbi_fed_tax_fed_fget, self->data_ptr);
}

static int
PaymentIncentives_set_cbi_fed_tax_fed(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_cbi_fed_tax_fed_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_cbi_fed_tax_sta(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_cbi_fed_tax_sta_fget, self->data_ptr);
}

static int
PaymentIncentives_set_cbi_fed_tax_sta(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_cbi_fed_tax_sta_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_cbi_oth_amount(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_cbi_oth_amount_fget, self->data_ptr);
}

static int
PaymentIncentives_set_cbi_oth_amount(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_cbi_oth_amount_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_cbi_oth_deprbas_fed(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_cbi_oth_deprbas_fed_fget, self->data_ptr);
}

static int
PaymentIncentives_set_cbi_oth_deprbas_fed(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_cbi_oth_deprbas_fed_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_cbi_oth_deprbas_sta(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_cbi_oth_deprbas_sta_fget, self->data_ptr);
}

static int
PaymentIncentives_set_cbi_oth_deprbas_sta(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_cbi_oth_deprbas_sta_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_cbi_oth_maxvalue(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_cbi_oth_maxvalue_fget, self->data_ptr);
}

static int
PaymentIncentives_set_cbi_oth_maxvalue(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_cbi_oth_maxvalue_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_cbi_oth_tax_fed(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_cbi_oth_tax_fed_fget, self->data_ptr);
}

static int
PaymentIncentives_set_cbi_oth_tax_fed(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_cbi_oth_tax_fed_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_cbi_oth_tax_sta(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_cbi_oth_tax_sta_fget, self->data_ptr);
}

static int
PaymentIncentives_set_cbi_oth_tax_sta(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_cbi_oth_tax_sta_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_cbi_sta_amount(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_cbi_sta_amount_fget, self->data_ptr);
}

static int
PaymentIncentives_set_cbi_sta_amount(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_cbi_sta_amount_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_cbi_sta_deprbas_fed(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_cbi_sta_deprbas_fed_fget, self->data_ptr);
}

static int
PaymentIncentives_set_cbi_sta_deprbas_fed(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_cbi_sta_deprbas_fed_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_cbi_sta_deprbas_sta(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_cbi_sta_deprbas_sta_fget, self->data_ptr);
}

static int
PaymentIncentives_set_cbi_sta_deprbas_sta(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_cbi_sta_deprbas_sta_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_cbi_sta_maxvalue(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_cbi_sta_maxvalue_fget, self->data_ptr);
}

static int
PaymentIncentives_set_cbi_sta_maxvalue(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_cbi_sta_maxvalue_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_cbi_sta_tax_fed(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_cbi_sta_tax_fed_fget, self->data_ptr);
}

static int
PaymentIncentives_set_cbi_sta_tax_fed(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_cbi_sta_tax_fed_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_cbi_sta_tax_sta(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_cbi_sta_tax_sta_fget, self->data_ptr);
}

static int
PaymentIncentives_set_cbi_sta_tax_sta(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_cbi_sta_tax_sta_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_cbi_uti_amount(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_cbi_uti_amount_fget, self->data_ptr);
}

static int
PaymentIncentives_set_cbi_uti_amount(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_cbi_uti_amount_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_cbi_uti_deprbas_fed(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_cbi_uti_deprbas_fed_fget, self->data_ptr);
}

static int
PaymentIncentives_set_cbi_uti_deprbas_fed(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_cbi_uti_deprbas_fed_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_cbi_uti_deprbas_sta(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_cbi_uti_deprbas_sta_fget, self->data_ptr);
}

static int
PaymentIncentives_set_cbi_uti_deprbas_sta(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_cbi_uti_deprbas_sta_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_cbi_uti_maxvalue(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_cbi_uti_maxvalue_fget, self->data_ptr);
}

static int
PaymentIncentives_set_cbi_uti_maxvalue(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_cbi_uti_maxvalue_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_cbi_uti_tax_fed(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_cbi_uti_tax_fed_fget, self->data_ptr);
}

static int
PaymentIncentives_set_cbi_uti_tax_fed(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_cbi_uti_tax_fed_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_cbi_uti_tax_sta(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_cbi_uti_tax_sta_fget, self->data_ptr);
}

static int
PaymentIncentives_set_cbi_uti_tax_sta(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_cbi_uti_tax_sta_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_fed_amount(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_fed_amount_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_fed_amount(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_fed_amount_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_fed_amount_deprbas_fed(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_fed_amount_deprbas_fed_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_fed_amount_deprbas_fed(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_fed_amount_deprbas_fed_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_fed_amount_deprbas_sta(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_fed_amount_deprbas_sta_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_fed_amount_deprbas_sta(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_fed_amount_deprbas_sta_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_fed_amount_tax_fed(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_fed_amount_tax_fed_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_fed_amount_tax_fed(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_fed_amount_tax_fed_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_fed_amount_tax_sta(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_fed_amount_tax_sta_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_fed_amount_tax_sta(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_fed_amount_tax_sta_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_fed_percent(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_fed_percent_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_fed_percent(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_fed_percent_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_fed_percent_deprbas_fed(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_fed_percent_deprbas_fed_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_fed_percent_deprbas_fed(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_fed_percent_deprbas_fed_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_fed_percent_deprbas_sta(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_fed_percent_deprbas_sta_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_fed_percent_deprbas_sta(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_fed_percent_deprbas_sta_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_fed_percent_maxvalue(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_fed_percent_maxvalue_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_fed_percent_maxvalue(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_fed_percent_maxvalue_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_fed_percent_tax_fed(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_fed_percent_tax_fed_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_fed_percent_tax_fed(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_fed_percent_tax_fed_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_fed_percent_tax_sta(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_fed_percent_tax_sta_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_fed_percent_tax_sta(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_fed_percent_tax_sta_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_oth_amount(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_oth_amount_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_oth_amount(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_oth_amount_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_oth_amount_deprbas_fed(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_oth_amount_deprbas_fed_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_oth_amount_deprbas_fed(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_oth_amount_deprbas_fed_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_oth_amount_deprbas_sta(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_oth_amount_deprbas_sta_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_oth_amount_deprbas_sta(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_oth_amount_deprbas_sta_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_oth_amount_tax_fed(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_oth_amount_tax_fed_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_oth_amount_tax_fed(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_oth_amount_tax_fed_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_oth_amount_tax_sta(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_oth_amount_tax_sta_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_oth_amount_tax_sta(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_oth_amount_tax_sta_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_oth_percent(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_oth_percent_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_oth_percent(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_oth_percent_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_oth_percent_deprbas_fed(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_oth_percent_deprbas_fed_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_oth_percent_deprbas_fed(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_oth_percent_deprbas_fed_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_oth_percent_deprbas_sta(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_oth_percent_deprbas_sta_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_oth_percent_deprbas_sta(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_oth_percent_deprbas_sta_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_oth_percent_maxvalue(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_oth_percent_maxvalue_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_oth_percent_maxvalue(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_oth_percent_maxvalue_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_oth_percent_tax_fed(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_oth_percent_tax_fed_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_oth_percent_tax_fed(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_oth_percent_tax_fed_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_oth_percent_tax_sta(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_oth_percent_tax_sta_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_oth_percent_tax_sta(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_oth_percent_tax_sta_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_sta_amount(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_sta_amount_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_sta_amount(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_sta_amount_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_sta_amount_deprbas_fed(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_sta_amount_deprbas_fed_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_sta_amount_deprbas_fed(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_sta_amount_deprbas_fed_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_sta_amount_deprbas_sta(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_sta_amount_deprbas_sta_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_sta_amount_deprbas_sta(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_sta_amount_deprbas_sta_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_sta_amount_tax_fed(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_sta_amount_tax_fed_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_sta_amount_tax_fed(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_sta_amount_tax_fed_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_sta_amount_tax_sta(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_sta_amount_tax_sta_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_sta_amount_tax_sta(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_sta_amount_tax_sta_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_sta_percent(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_sta_percent_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_sta_percent(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_sta_percent_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_sta_percent_deprbas_fed(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_sta_percent_deprbas_fed_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_sta_percent_deprbas_fed(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_sta_percent_deprbas_fed_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_sta_percent_deprbas_sta(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_sta_percent_deprbas_sta_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_sta_percent_deprbas_sta(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_sta_percent_deprbas_sta_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_sta_percent_maxvalue(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_sta_percent_maxvalue_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_sta_percent_maxvalue(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_sta_percent_maxvalue_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_sta_percent_tax_fed(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_sta_percent_tax_fed_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_sta_percent_tax_fed(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_sta_percent_tax_fed_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_sta_percent_tax_sta(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_sta_percent_tax_sta_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_sta_percent_tax_sta(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_sta_percent_tax_sta_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_uti_amount(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_uti_amount_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_uti_amount(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_uti_amount_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_uti_amount_deprbas_fed(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_uti_amount_deprbas_fed_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_uti_amount_deprbas_fed(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_uti_amount_deprbas_fed_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_uti_amount_deprbas_sta(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_uti_amount_deprbas_sta_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_uti_amount_deprbas_sta(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_uti_amount_deprbas_sta_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_uti_amount_tax_fed(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_uti_amount_tax_fed_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_uti_amount_tax_fed(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_uti_amount_tax_fed_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_uti_amount_tax_sta(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_uti_amount_tax_sta_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_uti_amount_tax_sta(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_uti_amount_tax_sta_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_uti_percent(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_uti_percent_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_uti_percent(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_uti_percent_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_uti_percent_deprbas_fed(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_uti_percent_deprbas_fed_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_uti_percent_deprbas_fed(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_uti_percent_deprbas_fed_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_uti_percent_deprbas_sta(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_uti_percent_deprbas_sta_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_uti_percent_deprbas_sta(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_uti_percent_deprbas_sta_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_uti_percent_maxvalue(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_uti_percent_maxvalue_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_uti_percent_maxvalue(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_uti_percent_maxvalue_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_uti_percent_tax_fed(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_uti_percent_tax_fed_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_uti_percent_tax_fed(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_uti_percent_tax_fed_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_ibi_uti_percent_tax_sta(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_ibi_uti_percent_tax_sta_fget, self->data_ptr);
}

static int
PaymentIncentives_set_ibi_uti_percent_tax_sta(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_ibi_uti_percent_tax_sta_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_pbi_fed_escal_fget, self->data_ptr);
}

static int
PaymentIncentives_set_pbi_fed_escal(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_pbi_fed_escal_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_pbi_fed_tax_fed(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_pbi_fed_tax_fed_fget, self->data_ptr);
}

static int
PaymentIncentives_set_pbi_fed_tax_fed(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_pbi_fed_tax_fed_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_pbi_fed_tax_sta(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_pbi_fed_tax_sta_fget, self->data_ptr);
}

static int
PaymentIncentives_set_pbi_fed_tax_sta(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_pbi_fed_tax_sta_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_pbi_fed_term(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_pbi_fed_term_fget, self->data_ptr);
}

static int
PaymentIncentives_set_pbi_fed_term(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_pbi_fed_term_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_pbi_oth_escal_fget, self->data_ptr);
}

static int
PaymentIncentives_set_pbi_oth_escal(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_pbi_oth_escal_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_pbi_oth_tax_fed(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_pbi_oth_tax_fed_fget, self->data_ptr);
}

static int
PaymentIncentives_set_pbi_oth_tax_fed(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_pbi_oth_tax_fed_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_pbi_oth_tax_sta(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_pbi_oth_tax_sta_fget, self->data_ptr);
}

static int
PaymentIncentives_set_pbi_oth_tax_sta(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_pbi_oth_tax_sta_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_pbi_oth_term(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_pbi_oth_term_fget, self->data_ptr);
}

static int
PaymentIncentives_set_pbi_oth_term(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_pbi_oth_term_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_pbi_sta_escal_fget, self->data_ptr);
}

static int
PaymentIncentives_set_pbi_sta_escal(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_pbi_sta_escal_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_pbi_sta_tax_fed(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_pbi_sta_tax_fed_fget, self->data_ptr);
}

static int
PaymentIncentives_set_pbi_sta_tax_fed(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_pbi_sta_tax_fed_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_pbi_sta_tax_sta(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_pbi_sta_tax_sta_fget, self->data_ptr);
}

static int
PaymentIncentives_set_pbi_sta_tax_sta(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_pbi_sta_tax_sta_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_pbi_sta_term(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_pbi_sta_term_fget, self->data_ptr);
}

static int
PaymentIncentives_set_pbi_sta_term(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_pbi_sta_term_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_pbi_uti_escal_fget, self->data_ptr);
}

static int
PaymentIncentives_set_pbi_uti_escal(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_pbi_uti_escal_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_pbi_uti_tax_fed(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_pbi_uti_tax_fed_fget, self->data_ptr);
}

static int
PaymentIncentives_set_pbi_uti_tax_fed(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_pbi_uti_tax_fed_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_pbi_uti_tax_sta(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_pbi_uti_tax_sta_fget, self->data_ptr);
}

static int
PaymentIncentives_set_pbi_uti_tax_sta(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_pbi_uti_tax_sta_fset, self->data_ptr);
}

static PyObject *
PaymentIncentives_get_pbi_uti_term(PaymentIncentivesObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_PaymentIncentives_pbi_uti_term_fget, self->data_ptr);
}

static int
PaymentIncentives_set_pbi_uti_term(PaymentIncentivesObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_PaymentIncentives_pbi_uti_term_fset, self->data_ptr);
}
...
static PyObject *
Common_new(SAM_Equpartflip data_ptr)
{
...
Common_assign(CommonObject *self, PyObject *args)
{
	...
	if (!PySAM_assign_from_dict(self->data_ptr, dict, "Equpartflip", "Common")){
		return NULL;
	}
...
{
	return PySAM_array_getter(SAM_Equpartflip_Common_gen_aget, self->data_ptr);
}

static int
Common_set_gen(CommonObject *self, PyObject *value, void *closure)
{
		return PySAM_array_setter(value, SAM_Equpartflip_Common_gen_aset, self->data_ptr);
}
...
static PyObject *
DHF_new(SAM_Equpartflip data_ptr)
{
...
DHF_assign(DHFObject *self, PyObject *args)
{
	...
	if (!PySAM_assign_from_dict(self->data_ptr, dict, "Equpartflip", "DHF")){
		return NULL;
	}
...
{
	return PySAM_array_getter(SAM_Equpartflip_DHF_degradation_aget, self->data_ptr);
}

static int
DHF_set_degradation(DHFObject *self, PyObject *value, void *closure)
{
		return PySAM_array_setter(value, SAM_Equpartflip_DHF_degradation_aset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_SystemOutput_system_capacity_fget, self->data_ptr);
}

static int
SystemOutput_set_system_capacity(SystemOutputObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_SystemOutput_system_capacity_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_Recapitalization_system_recapitalization_cost_fget, self->data_ptr);
}

static int
Recapitalization_set_system_recapitalization_cost(RecapitalizationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Recapitalization_system_recapitalization_cost_fset, self->data_ptr);
}

static PyObject *
Recapitalization_get_system_recapitalization_escalation(RecapitalizationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Recapitalization_system_recapitalization_escalation_fget, self->data_ptr);
}

static int
Recapitalization_set_system_recapitalization_escalation(RecapitalizationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Recapitalization_system_recapitalization_escalation_fset, self->data_ptr);
}

static PyObject *
Recapitalization_get_system_use_recapitalization(RecapitalizationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Recapitalization_system_use_recapitalization_fget, self->data_ptr);
}

static int
Recapitalization_set_system_use_recapitalization(RecapitalizationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Recapitalization_system_use_recapitalization_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_TimeOfDelivery_dispatch_factor1_fget, self->data_ptr);
}

static int
TimeOfDelivery_set_dispatch_factor1(TimeOfDeliveryObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TimeOfDelivery_dispatch_factor1_fset, self->data_ptr);
}

static PyObject *
TimeOfDelivery_get_dispatch_factor2(TimeOfDeliveryObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_TimeOfDelivery_dispatch_factor2_fget, self->data_ptr);
}

static int
TimeOfDelivery_set_dispatch_factor2(TimeOfDeliveryObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TimeOfDelivery_dispatch_factor2_fset, self->data_ptr);
}

static PyObject *
TimeOfDelivery_get_dispatch_factor3(TimeOfDeliveryObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_TimeOfDelivery_dispatch_factor3_fget, self->data_ptr);
}

static int
TimeOfDelivery_set_dispatch_factor3(TimeOfDeliveryObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TimeOfDelivery_dispatch_factor3_fset, self->data_ptr);
}

static PyObject *
TimeOfDelivery_get_dispatch_factor4(TimeOfDeliveryObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_TimeOfDelivery_dispatch_factor4_fget, self->data_ptr);
}

static int
TimeOfDelivery_set_dispatch_factor4(TimeOfDeliveryObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TimeOfDelivery_dispatch_factor4_fset, self->data_ptr);
}

static PyObject *
TimeOfDelivery_get_dispatch_factor5(TimeOfDeliveryObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_TimeOfDelivery_dispatch_factor5_fget, self->data_ptr);
}

static int
TimeOfDelivery_set_dispatch_factor5(TimeOfDeliveryObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TimeOfDelivery_dispatch_factor5_fset, self->data_ptr);
}

static PyObject *
TimeOfDelivery_get_dispatch_factor6(TimeOfDeliveryObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_TimeOfDelivery_dispatch_factor6_fget, self->data_ptr);
}

static int
TimeOfDelivery_set_dispatch_factor6(TimeOfDeliveryObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TimeOfDelivery_dispatch_factor6_fset, self->data_ptr);
}

static PyObject *
TimeOfDelivery_get_dispatch_factor7(TimeOfDeliveryObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_TimeOfDelivery_dispatch_factor7_fget, self->data_ptr);
}

static int
TimeOfDelivery_set_dispatch_factor7(TimeOfDeliveryObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TimeOfDelivery_dispatch_factor7_fset, self->data_ptr);
}

static PyObject *
TimeOfDelivery_get_dispatch_factor8(TimeOfDeliveryObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_TimeOfDelivery_dispatch_factor8_fget, self->data_ptr);
}

static int
TimeOfDelivery_set_dispatch_factor8(TimeOfDeliveryObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TimeOfDelivery_dispatch_factor8_fset, self->data_ptr);
}

static PyObject *
TimeOfDelivery_get_dispatch_factor9(TimeOfDeliveryObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_TimeOfDelivery_dispatch_factor9_fget, self->data_ptr);
}

static int
TimeOfDelivery_set_dispatch_factor9(TimeOfDeliveryObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TimeOfDelivery_dispatch_factor9_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_TimeOfDelivery_ppa_multiplier_model_fget, self->data_ptr);
}

static int
TimeOfDelivery_set_ppa_multiplier_model(TimeOfDeliveryObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TimeOfDelivery_ppa_multiplier_model_fset, self->data_ptr);
}

static PyObject *
TimeOfDelivery_get_system_use_lifetime_output(TimeOfDeliveryObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_TimeOfDelivery_system_use_lifetime_output_fget, self->data_ptr);
}

static int
TimeOfDelivery_set_system_use_lifetime_output(TimeOfDeliveryObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_TimeOfDelivery_system_use_lifetime_output_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_ReserveAccounts_equip1_reserve_cost_fget, self->data_ptr);
}

static int
ReserveAccounts_set_equip1_reserve_cost(ReserveAccountsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_ReserveAccounts_equip1_reserve_cost_fset, self->data_ptr);
}

static PyObject *
ReserveAccounts_get_equip1_reserve_freq(ReserveAccountsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_ReserveAccounts_equip1_reserve_freq_fget, self->data_ptr);
}

static int
ReserveAccounts_set_equip1_reserve_freq(ReserveAccountsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_ReserveAccounts_equip1_reserve_freq_fset, self->data_ptr);
}

static PyObject *
ReserveAccounts_get_equip2_reserve_cost(ReserveAccountsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_ReserveAccounts_equip2_reserve_cost_fget, self->data_ptr);
}

static int
ReserveAccounts_set_equip2_reserve_cost(ReserveAccountsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_ReserveAccounts_equip2_reserve_cost_fset, self->data_ptr);
}

static PyObject *
ReserveAccounts_get_equip2_reserve_freq(ReserveAccountsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_ReserveAccounts_equip2_reserve_freq_fget, self->data_ptr);
}

static int
ReserveAccounts_set_equip2_reserve_freq(ReserveAccountsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_ReserveAccounts_equip2_reserve_freq_fset, self->data_ptr);
}

static PyObject *
ReserveAccounts_get_equip3_reserve_cost(ReserveAccountsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_ReserveAccounts_equip3_reserve_cost_fget, self->data_ptr);
}

static int
ReserveAccounts_set_equip3_reserve_cost(ReserveAccountsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_ReserveAccounts_equip3_reserve_cost_fset, self->data_ptr);
}

static PyObject *
ReserveAccounts_get_equip3_reserve_freq(ReserveAccountsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_ReserveAccounts_equip3_reserve_freq_fget, self->data_ptr);
}

static int
ReserveAccounts_set_equip3_reserve_freq(ReserveAccountsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_ReserveAccounts_equip3_reserve_freq_fset, self->data_ptr);
}

static PyObject *
ReserveAccounts_get_reserves_interest(ReserveAccountsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_ReserveAccounts_reserves_interest_fget, self->data_ptr);
}

static int
ReserveAccounts_set_reserves_interest(ReserveAccountsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_ReserveAccounts_reserves_interest_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_alloc_custom_percent_fget, self->data_ptr);
}

static int
Depreciation_set_depr_alloc_custom_percent(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_alloc_custom_percent_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_alloc_macrs_15_percent(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_alloc_macrs_15_percent_fget, self->data_ptr);
}

static int
Depreciation_set_depr_alloc_macrs_15_percent(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_alloc_macrs_15_percent_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_alloc_macrs_5_percent(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_alloc_macrs_5_percent_fget, self->data_ptr);
}

static int
Depreciation_set_depr_alloc_macrs_5_percent(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_alloc_macrs_5_percent_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_alloc_sl_15_percent(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_alloc_sl_15_percent_fget, self->data_ptr);
}

static int
Depreciation_set_depr_alloc_sl_15_percent(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_alloc_sl_15_percent_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_alloc_sl_20_percent(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_alloc_sl_20_percent_fget, self->data_ptr);
}

static int
Depreciation_set_depr_alloc_sl_20_percent(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_alloc_sl_20_percent_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_alloc_sl_39_percent(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_alloc_sl_39_percent_fget, self->data_ptr);
}

static int
Depreciation_set_depr_alloc_sl_39_percent(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_alloc_sl_39_percent_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_alloc_sl_5_percent(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_alloc_sl_5_percent_fget, self->data_ptr);
}

static int
Depreciation_set_depr_alloc_sl_5_percent(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_alloc_sl_5_percent_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_bonus_fed(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_bonus_fed_fget, self->data_ptr);
}

static int
Depreciation_set_depr_bonus_fed(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_bonus_fed_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_bonus_fed_custom(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_bonus_fed_custom_fget, self->data_ptr);
}

static int
Depreciation_set_depr_bonus_fed_custom(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_bonus_fed_custom_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_bonus_fed_macrs_15(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_bonus_fed_macrs_15_fget, self->data_ptr);
}

static int
Depreciation_set_depr_bonus_fed_macrs_15(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_bonus_fed_macrs_15_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_bonus_fed_macrs_5(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_bonus_fed_macrs_5_fget, self->data_ptr);
}

static int
Depreciation_set_depr_bonus_fed_macrs_5(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_bonus_fed_macrs_5_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_bonus_fed_sl_15(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_bonus_fed_sl_15_fget, self->data_ptr);
}

static int
Depreciation_set_depr_bonus_fed_sl_15(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_bonus_fed_sl_15_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_bonus_fed_sl_20(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_bonus_fed_sl_20_fget, self->data_ptr);
}

static int
Depreciation_set_depr_bonus_fed_sl_20(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_bonus_fed_sl_20_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_bonus_fed_sl_39(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_bonus_fed_sl_39_fget, self->data_ptr);
}

static int
Depreciation_set_depr_bonus_fed_sl_39(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_bonus_fed_sl_39_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_bonus_fed_sl_5(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_bonus_fed_sl_5_fget, self->data_ptr);
}

static int
Depreciation_set_depr_bonus_fed_sl_5(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_bonus_fed_sl_5_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_bonus_sta(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_bonus_sta_fget, self->data_ptr);
}

static int
Depreciation_set_depr_bonus_sta(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_bonus_sta_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_bonus_sta_custom(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_bonus_sta_custom_fget, self->data_ptr);
}

static int
Depreciation_set_depr_bonus_sta_custom(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_bonus_sta_custom_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_bonus_sta_macrs_15(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_bonus_sta_macrs_15_fget, self->data_ptr);
}

static int
Depreciation_set_depr_bonus_sta_macrs_15(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_bonus_sta_macrs_15_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_bonus_sta_macrs_5(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_bonus_sta_macrs_5_fget, self->data_ptr);
}

static int
Depreciation_set_depr_bonus_sta_macrs_5(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_bonus_sta_macrs_5_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_bonus_sta_sl_15(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_bonus_sta_sl_15_fget, self->data_ptr);
}

static int
Depreciation_set_depr_bonus_sta_sl_15(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_bonus_sta_sl_15_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_bonus_sta_sl_20(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_bonus_sta_sl_20_fget, self->data_ptr);
}

static int
Depreciation_set_depr_bonus_sta_sl_20(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_bonus_sta_sl_20_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_bonus_sta_sl_39(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_bonus_sta_sl_39_fget, self->data_ptr);
}

static int
Depreciation_set_depr_bonus_sta_sl_39(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_bonus_sta_sl_39_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_bonus_sta_sl_5(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_bonus_sta_sl_5_fget, self->data_ptr);
}

static int
Depreciation_set_depr_bonus_sta_sl_5(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_bonus_sta_sl_5_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_fedbas_method_fget, self->data_ptr);
}

static int
Depreciation_set_depr_fedbas_method(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_fedbas_method_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_itc_fed_custom(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_itc_fed_custom_fget, self->data_ptr);
}

static int
Depreciation_set_depr_itc_fed_custom(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_itc_fed_custom_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_itc_fed_macrs_15(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_itc_fed_macrs_15_fget, self->data_ptr);
}

static int
Depreciation_set_depr_itc_fed_macrs_15(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_itc_fed_macrs_15_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_itc_fed_macrs_5(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_itc_fed_macrs_5_fget, self->data_ptr);
}

static int
Depreciation_set_depr_itc_fed_macrs_5(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_itc_fed_macrs_5_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_itc_fed_sl_15(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_itc_fed_sl_15_fget, self->data_ptr);
}

static int
Depreciation_set_depr_itc_fed_sl_15(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_itc_fed_sl_15_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_itc_fed_sl_20(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_itc_fed_sl_20_fget, self->data_ptr);
}

static int
Depreciation_set_depr_itc_fed_sl_20(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_itc_fed_sl_20_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_itc_fed_sl_39(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_itc_fed_sl_39_fget, self->data_ptr);
}

static int
Depreciation_set_depr_itc_fed_sl_39(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_itc_fed_sl_39_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_itc_fed_sl_5(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_itc_fed_sl_5_fget, self->data_ptr);
}

static int
Depreciation_set_depr_itc_fed_sl_5(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_itc_fed_sl_5_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_itc_sta_custom(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_itc_sta_custom_fget, self->data_ptr);
}

static int
Depreciation_set_depr_itc_sta_custom(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_itc_sta_custom_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_itc_sta_macrs_15(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_itc_sta_macrs_15_fget, self->data_ptr);
}

static int
Depreciation_set_depr_itc_sta_macrs_15(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_itc_sta_macrs_15_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_itc_sta_macrs_5(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_itc_sta_macrs_5_fget, self->data_ptr);
}

static int
Depreciation_set_depr_itc_sta_macrs_5(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_itc_sta_macrs_5_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_itc_sta_sl_15(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_itc_sta_sl_15_fget, self->data_ptr);
}

static int
Depreciation_set_depr_itc_sta_sl_15(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_itc_sta_sl_15_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_itc_sta_sl_20(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_itc_sta_sl_20_fget, self->data_ptr);
}

static int
Depreciation_set_depr_itc_sta_sl_20(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_itc_sta_sl_20_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_itc_sta_sl_39(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_itc_sta_sl_39_fget, self->data_ptr);
}

static int
Depreciation_set_depr_itc_sta_sl_39(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_itc_sta_sl_39_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_itc_sta_sl_5(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_itc_sta_sl_5_fget, self->data_ptr);
}

static int
Depreciation_set_depr_itc_sta_sl_5(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_itc_sta_sl_5_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_depr_stabas_method(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_depr_stabas_method_fget, self->data_ptr);
}

static int
Depreciation_set_depr_stabas_method(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_depr_stabas_method_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_equip_reserve_depr_fed(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_equip_reserve_depr_fed_fget, self->data_ptr);
}

static int
Depreciation_set_equip_reserve_depr_fed(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_equip_reserve_depr_fed_fset, self->data_ptr);
}

static PyObject *
Depreciation_get_equip_reserve_depr_sta(DepreciationObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Depreciation_equip_reserve_depr_sta_fget, self->data_ptr);
}

static int
Depreciation_set_equip_reserve_depr_sta(DepreciationObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Depreciation_equip_reserve_depr_sta_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_SalvageValue_salvage_percentage_fget, self->data_ptr);
}

static int
SalvageValue_set_salvage_percentage(SalvageValueObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_SalvageValue_salvage_percentage_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_SolutionMode_ppa_escalation_fget, self->data_ptr);
}

static int
SolutionMode_set_ppa_escalation(SolutionModeObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_SolutionMode_ppa_escalation_fset, self->data_ptr);
}

static PyObject *
SolutionMode_get_ppa_price_input(SolutionModeObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_SolutionMode_ppa_price_input_fget, self->data_ptr);
}

static int
SolutionMode_set_ppa_price_input(SolutionModeObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_SolutionMode_ppa_price_input_fset, self->data_ptr);
}

static PyObject *
SolutionMode_get_ppa_soln_max(SolutionModeObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_SolutionMode_ppa_soln_max_fget, self->data_ptr);
}

static int
SolutionMode_set_ppa_soln_max(SolutionModeObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_SolutionMode_ppa_soln_max_fset, self->data_ptr);
}

static PyObject *
SolutionMode_get_ppa_soln_max_iterations(SolutionModeObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_SolutionMode_ppa_soln_max_iterations_fget, self->data_ptr);
}

static int
SolutionMode_set_ppa_soln_max_iterations(SolutionModeObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_SolutionMode_ppa_soln_max_iterations_fset, self->data_ptr);
}

static PyObject *
SolutionMode_get_ppa_soln_min(SolutionModeObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_SolutionMode_ppa_soln_min_fget, self->data_ptr);
}

static int
SolutionMode_set_ppa_soln_min(SolutionModeObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_SolutionMode_ppa_soln_min_fset, self->data_ptr);
}

static PyObject *
SolutionMode_get_ppa_soln_mode(SolutionModeObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_SolutionMode_ppa_soln_mode_fget, self->data_ptr);
}

static int
SolutionMode_set_ppa_soln_mode(SolutionModeObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_SolutionMode_ppa_soln_mode_fset, self->data_ptr);
}

static PyObject *
SolutionMode_get_ppa_soln_tolerance(SolutionModeObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_SolutionMode_ppa_soln_tolerance_fget, self->data_ptr);
}

static int
SolutionMode_set_ppa_soln_tolerance(SolutionModeObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_SolutionMode_ppa_soln_tolerance_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_ConstructionFinancing_construction_financing_cost_fget, self->data_ptr);
}

static int
ConstructionFinancing_set_construction_financing_cost(ConstructionFinancingObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_ConstructionFinancing_construction_financing_cost_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_OtherCapitalCosts_cost_dev_fee_percent_fget, self->data_ptr);
}

static int
OtherCapitalCosts_set_cost_dev_fee_percent(OtherCapitalCostsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_OtherCapitalCosts_cost_dev_fee_percent_fset, self->data_ptr);
}

static PyObject *
OtherCapitalCosts_get_cost_equity_closing(OtherCapitalCostsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_OtherCapitalCosts_cost_equity_closing_fget, self->data_ptr);
}

static int
OtherCapitalCosts_set_cost_equity_closing(OtherCapitalCostsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_OtherCapitalCosts_cost_equity_closing_fset, self->data_ptr);
}

static PyObject *
OtherCapitalCosts_get_cost_other_financing(OtherCapitalCostsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_OtherCapitalCosts_cost_other_financing_fget, self->data_ptr);
}

static int
OtherCapitalCosts_set_cost_other_financing(OtherCapitalCostsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_OtherCapitalCosts_cost_other_financing_fset, self->data_ptr);
}

static PyObject *
OtherCapitalCosts_get_months_receivables_reserve(OtherCapitalCostsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_OtherCapitalCosts_months_receivables_reserve_fget, self->data_ptr);
}

static int
OtherCapitalCosts_set_months_receivables_reserve(OtherCapitalCostsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_OtherCapitalCosts_months_receivables_reserve_fset, self->data_ptr);
}

static PyObject *
OtherCapitalCosts_get_months_working_reserve(OtherCapitalCostsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_OtherCapitalCosts_months_working_reserve_fget, self->data_ptr);
}

static int
OtherCapitalCosts_set_months_working_reserve(OtherCapitalCostsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_OtherCapitalCosts_months_working_reserve_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_IRRTargets_flip_target_percent_fget, self->data_ptr);
}

static int
IRRTargets_set_flip_target_percent(IRRTargetsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_IRRTargets_flip_target_percent_fset, self->data_ptr);
}

static PyObject *
IRRTargets_get_flip_target_year(IRRTargetsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_IRRTargets_flip_target_year_fget, self->data_ptr);
}

static int
IRRTargets_set_flip_target_year(IRRTargetsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_IRRTargets_flip_target_year_fset, self->data_ptr);
}

static PyObject *
IRRTargets_get_tax_investor_equity_percent(IRRTargetsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_IRRTargets_tax_investor_equity_percent_fget, self->data_ptr);
}

static int
IRRTargets_set_tax_investor_equity_percent(IRRTargetsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_IRRTargets_tax_investor_equity_percent_fset, self->data_ptr);
}

static PyObject *
IRRTargets_get_tax_investor_postflip_cash_percent(IRRTargetsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_IRRTargets_tax_investor_postflip_cash_percent_fget, self->data_ptr);
}

static int
IRRTargets_set_tax_investor_postflip_cash_percent(IRRTargetsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_IRRTargets_tax_investor_postflip_cash_percent_fset, self->data_ptr);
}

static PyObject *
IRRTargets_get_tax_investor_postflip_tax_percent(IRRTargetsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_IRRTargets_tax_investor_postflip_tax_percent_fget, self->data_ptr);
}

static int
IRRTargets_set_tax_investor_postflip_tax_percent(IRRTargetsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_IRRTargets_tax_investor_postflip_tax_percent_fset, self->data_ptr);
}

static PyObject *
IRRTargets_get_tax_investor_preflip_cash_percent(IRRTargetsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_IRRTargets_tax_investor_preflip_cash_percent_fget, self->data_ptr);
}

static int
IRRTargets_set_tax_investor_preflip_cash_percent(IRRTargetsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_IRRTargets_tax_investor_preflip_cash_percent_fset, self->data_ptr);
}

static PyObject *
IRRTargets_get_tax_investor_preflip_tax_percent(IRRTargetsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_IRRTargets_tax_investor_preflip_tax_percent_fget, self->data_ptr);
}

static int
IRRTargets_set_tax_investor_preflip_tax_percent(IRRTargetsObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_IRRTargets_tax_investor_preflip_tax_percent_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_DeveloperCapitalRecovery_sponsor_cap_recovery_mode_fget, self->data_ptr);
}

static int
DeveloperCapitalRecovery_set_sponsor_cap_recovery_mode(DeveloperCapitalRecoveryObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_DeveloperCapitalRecovery_sponsor_cap_recovery_mode_fset, self->data_ptr);
}

static PyObject *
DeveloperCapitalRecovery_get_sponsor_cap_recovery_year(DeveloperCapitalRecoveryObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_DeveloperCapitalRecovery_sponsor_cap_recovery_year_fget, self->data_ptr);
}

static int
DeveloperCapitalRecovery_set_sponsor_cap_recovery_year(DeveloperCapitalRecoveryObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_DeveloperCapitalRecovery_sponsor_cap_recovery_year_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_Battery_batt_computed_bank_capacity_fget, self->data_ptr);
}

static int
Battery_set_batt_computed_bank_capacity(BatteryObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Battery_batt_computed_bank_capacity_fset, self->data_ptr);
}

static PyObject *
Battery_get_batt_replacement_option(BatteryObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Battery_batt_replacement_option_fget, self->data_ptr);
}

static int
Battery_set_batt_replacement_option(BatteryObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Battery_batt_replacement_option_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_Battery_battery_per_kWh_fget, self->data_ptr);
}

static int
Battery_set_battery_per_kWh(BatteryObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Battery_battery_per_kWh_fset, self->data_ptr);
}

static PyObject *
Battery_get_en_batt(BatteryObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Battery_en_batt_fget, self->data_ptr);
}

static int
Battery_set_en_batt(BatteryObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Equpartflip_Battery_en_batt_fset, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_adjusted_installed_cost_fget, self->data_ptr);
}

static PyObject *
Outputs_get_analysis_period_irr(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_analysis_period_irr_fget, self->data_ptr);
}

static PyObject *
Outputs_get_cbi_fedtax_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_cbi_fedtax_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_cbi_statax_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_cbi_statax_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_cbi_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_cbi_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_cbi_total_fed(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_cbi_total_fed_fget, self->data_ptr);
}

static PyObject *
Outputs_get_cbi_total_oth(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_cbi_total_oth_fget, self->data_ptr);
}

static PyObject *
Outputs_get_cbi_total_sta(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_cbi_total_sta_fget, self->data_ptr);
}

static PyObject *
Outputs_get_cbi_total_uti(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_cbi_total_uti_fget, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_cf_length_fget, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_cost_financing_fget, self->data_ptr);
}

static PyObject *
Outputs_get_cost_installed(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_cost_installed_fget, self->data_ptr);
}

static PyObject *
Outputs_get_cost_installedperwatt(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_cost_installedperwatt_fget, self->data_ptr);
}

static PyObject *
Outputs_get_cost_prefinancing(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_cost_prefinancing_fget, self->data_ptr);
}

static PyObject *
Outputs_get_debt_fraction(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_debt_fraction_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_alloc_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_alloc_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_alloc_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_alloc_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_alloc_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_alloc_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_alloc_none(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_alloc_none_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_alloc_none_percent(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_alloc_none_percent_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_alloc_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_alloc_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_alloc_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_alloc_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_alloc_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_alloc_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_alloc_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_alloc_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_alloc_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_alloc_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_after_itc_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_after_itc_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_after_itc_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_after_itc_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_after_itc_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_after_itc_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_after_itc_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_after_itc_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_after_itc_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_after_itc_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_after_itc_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_after_itc_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_after_itc_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_after_itc_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_after_itc_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_after_itc_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_cbi_reduc_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_cbi_reduc_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_cbi_reduc_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_cbi_reduc_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_cbi_reduc_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_cbi_reduc_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_cbi_reduc_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_cbi_reduc_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_cbi_reduc_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_cbi_reduc_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_cbi_reduc_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_cbi_reduc_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_cbi_reduc_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_cbi_reduc_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_cbi_reduc_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_cbi_reduc_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_first_year_bonus_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_first_year_bonus_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_first_year_bonus_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_first_year_bonus_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_first_year_bonus_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_first_year_bonus_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_first_year_bonus_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_first_year_bonus_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_first_year_bonus_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_first_year_bonus_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_first_year_bonus_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_first_year_bonus_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_first_year_bonus_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_first_year_bonus_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_first_year_bonus_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_first_year_bonus_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_fixed_amount_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_fixed_amount_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_fixed_amount_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_fixed_amount_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_fixed_amount_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_fixed_amount_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_fixed_amount_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_fixed_amount_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_fixed_amount_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_fixed_amount_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_fixed_amount_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_fixed_amount_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_fixed_amount_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_fixed_amount_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_fixed_amount_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_fixed_amount_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_ibi_reduc_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_ibi_reduc_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_ibi_reduc_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_ibi_reduc_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_ibi_reduc_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_ibi_reduc_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_ibi_reduc_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_ibi_reduc_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_ibi_reduc_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_ibi_reduc_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_ibi_reduc_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_ibi_reduc_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_ibi_reduc_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_ibi_reduc_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_ibi_reduc_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_ibi_reduc_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_itc_fed_reduction_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_itc_fed_reduction_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_itc_fed_reduction_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_itc_fed_reduction_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_itc_fed_reduction_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_itc_fed_reduction_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_itc_fed_reduction_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_itc_fed_reduction_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_itc_fed_reduction_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_itc_fed_reduction_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_itc_fed_reduction_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_itc_fed_reduction_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_itc_fed_reduction_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_itc_fed_reduction_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_itc_fed_reduction_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_itc_fed_reduction_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_itc_sta_reduction_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_itc_sta_reduction_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_itc_sta_reduction_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_itc_sta_reduction_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_itc_sta_reduction_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_itc_sta_reduction_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_itc_sta_reduction_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_itc_sta_reduction_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_itc_sta_reduction_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_itc_sta_reduction_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_itc_sta_reduction_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_itc_sta_reduction_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_itc_sta_reduction_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_itc_sta_reduction_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_itc_sta_reduction_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_itc_sta_reduction_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_percent_amount_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_percent_amount_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_percent_amount_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_percent_amount_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_percent_amount_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_percent_amount_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_percent_amount_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_percent_amount_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_percent_amount_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_percent_amount_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_percent_amount_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_percent_amount_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_percent_amount_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_percent_amount_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_percent_amount_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_percent_amount_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_percent_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_percent_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_percent_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_percent_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_percent_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_percent_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_percent_qual_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_percent_qual_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_percent_qual_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_percent_qual_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_percent_qual_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_percent_qual_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_percent_qual_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_percent_qual_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_percent_qual_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_percent_qual_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_percent_qual_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_percent_qual_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_percent_qual_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_percent_qual_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_percent_qual_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_percent_qual_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_percent_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_percent_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_percent_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_percent_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_percent_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_percent_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_percent_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_percent_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_percent_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_percent_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_prior_itc_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_prior_itc_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_prior_itc_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_prior_itc_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_prior_itc_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_prior_itc_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_prior_itc_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_prior_itc_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_prior_itc_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_prior_itc_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_prior_itc_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_prior_itc_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_prior_itc_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_prior_itc_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_prior_itc_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_prior_itc_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_fedbas_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_fedbas_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_after_itc_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_after_itc_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_after_itc_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_after_itc_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_after_itc_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_after_itc_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_after_itc_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_after_itc_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_after_itc_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_after_itc_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_after_itc_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_after_itc_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_after_itc_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_after_itc_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_after_itc_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_after_itc_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_cbi_reduc_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_cbi_reduc_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_cbi_reduc_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_cbi_reduc_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_cbi_reduc_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_cbi_reduc_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_cbi_reduc_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_cbi_reduc_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_cbi_reduc_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_cbi_reduc_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_cbi_reduc_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_cbi_reduc_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_cbi_reduc_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_cbi_reduc_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_cbi_reduc_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_cbi_reduc_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_first_year_bonus_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_first_year_bonus_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_first_year_bonus_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_first_year_bonus_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_first_year_bonus_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_first_year_bonus_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_first_year_bonus_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_first_year_bonus_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_first_year_bonus_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_first_year_bonus_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_first_year_bonus_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_first_year_bonus_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_first_year_bonus_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_first_year_bonus_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_first_year_bonus_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_first_year_bonus_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_fixed_amount_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_fixed_amount_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_fixed_amount_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_fixed_amount_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_fixed_amount_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_fixed_amount_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_fixed_amount_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_fixed_amount_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_fixed_amount_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_fixed_amount_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_fixed_amount_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_fixed_amount_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_fixed_amount_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_fixed_amount_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_fixed_amount_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_fixed_amount_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_ibi_reduc_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_ibi_reduc_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_ibi_reduc_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_ibi_reduc_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_ibi_reduc_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_ibi_reduc_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_ibi_reduc_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_ibi_reduc_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_ibi_reduc_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_ibi_reduc_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_ibi_reduc_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_ibi_reduc_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_ibi_reduc_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_ibi_reduc_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_ibi_reduc_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_ibi_reduc_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_itc_fed_reduction_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_itc_fed_reduction_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_itc_fed_reduction_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_itc_fed_reduction_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_itc_fed_reduction_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_itc_fed_reduction_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_itc_fed_reduction_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_itc_fed_reduction_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_itc_fed_reduction_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_itc_fed_reduction_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_itc_fed_reduction_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_itc_fed_reduction_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_itc_fed_reduction_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_itc_fed_reduction_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_itc_fed_reduction_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_itc_fed_reduction_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_itc_sta_reduction_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_itc_sta_reduction_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_itc_sta_reduction_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_itc_sta_reduction_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_itc_sta_reduction_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_itc_sta_reduction_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_itc_sta_reduction_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_itc_sta_reduction_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_itc_sta_reduction_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_itc_sta_reduction_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_itc_sta_reduction_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_itc_sta_reduction_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_itc_sta_reduction_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_itc_sta_reduction_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_itc_sta_reduction_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_itc_sta_reduction_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_percent_amount_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_percent_amount_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_percent_amount_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_percent_amount_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_percent_amount_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_percent_amount_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_percent_amount_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_percent_amount_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_percent_amount_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_percent_amount_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_percent_amount_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_percent_amount_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_percent_amount_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_percent_amount_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_percent_amount_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_percent_amount_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_percent_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_percent_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_percent_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_percent_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_percent_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_percent_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_percent_qual_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_percent_qual_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_percent_qual_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_percent_qual_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_percent_qual_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_percent_qual_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_percent_qual_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_percent_qual_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_percent_qual_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_percent_qual_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_percent_qual_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_percent_qual_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_percent_qual_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_percent_qual_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_percent_qual_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_percent_qual_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_percent_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_percent_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_percent_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_percent_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_percent_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_percent_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_percent_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_percent_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_percent_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_percent_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_prior_itc_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_prior_itc_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_prior_itc_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_prior_itc_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_prior_itc_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_prior_itc_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_prior_itc_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_prior_itc_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_prior_itc_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_prior_itc_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_prior_itc_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_prior_itc_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_prior_itc_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_prior_itc_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_prior_itc_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_prior_itc_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_depr_stabas_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_depr_stabas_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_effective_tax_rate(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_effective_tax_rate_fget, self->data_ptr);
}

static PyObject *
Outputs_get_firstyear_energy_dispatch1(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_firstyear_energy_dispatch1_fget, self->data_ptr);
}

static PyObject *
Outputs_get_firstyear_energy_dispatch2(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_firstyear_energy_dispatch2_fget, self->data_ptr);
}

static PyObject *
Outputs_get_firstyear_energy_dispatch3(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_firstyear_energy_dispatch3_fget, self->data_ptr);
}

static PyObject *
Outputs_get_firstyear_energy_dispatch4(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_firstyear_energy_dispatch4_fget, self->data_ptr);
}

static PyObject *
Outputs_get_firstyear_energy_dispatch5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_firstyear_energy_dispatch5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_firstyear_energy_dispatch6(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_firstyear_energy_dispatch6_fget, self->data_ptr);
}

static PyObject *
Outputs_get_firstyear_energy_dispatch7(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_firstyear_energy_dispatch7_fget, self->data_ptr);
}

static PyObject *
Outputs_get_firstyear_energy_dispatch8(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_firstyear_energy_dispatch8_fget, self->data_ptr);
}

static PyObject *
Outputs_get_firstyear_energy_dispatch9(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_firstyear_energy_dispatch9_fget, self->data_ptr);
}

static PyObject *
Outputs_get_firstyear_energy_price1(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_firstyear_energy_price1_fget, self->data_ptr);
}

static PyObject *
Outputs_get_firstyear_energy_price2(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_firstyear_energy_price2_fget, self->data_ptr);
}

static PyObject *
Outputs_get_firstyear_energy_price3(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_firstyear_energy_price3_fget, self->data_ptr);
}

static PyObject *
Outputs_get_firstyear_energy_price4(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_firstyear_energy_price4_fget, self->data_ptr);
}

static PyObject *
Outputs_get_firstyear_energy_price5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_firstyear_energy_price5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_firstyear_energy_price6(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_firstyear_energy_price6_fget, self->data_ptr);
}

static PyObject *
Outputs_get_firstyear_energy_price7(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_firstyear_energy_price7_fget, self->data_ptr);
}

static PyObject *
Outputs_get_firstyear_energy_price8(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_firstyear_energy_price8_fget, self->data_ptr);
}

static PyObject *
Outputs_get_firstyear_energy_price9(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_firstyear_energy_price9_fget, self->data_ptr);
}

static PyObject *
Outputs_get_firstyear_revenue_dispatch1(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_firstyear_revenue_dispatch1_fget, self->data_ptr);
}

static PyObject *
Outputs_get_firstyear_revenue_dispatch2(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_firstyear_revenue_dispatch2_fget, self->data_ptr);
}

static PyObject *
Outputs_get_firstyear_revenue_dispatch3(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_firstyear_revenue_dispatch3_fget, self->data_ptr);
}

static PyObject *
Outputs_get_firstyear_revenue_dispatch4(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_firstyear_revenue_dispatch4_fget, self->data_ptr);
}

static PyObject *
Outputs_get_firstyear_revenue_dispatch5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_firstyear_revenue_dispatch5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_firstyear_revenue_dispatch6(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_firstyear_revenue_dispatch6_fget, self->data_ptr);
}

static PyObject *
Outputs_get_firstyear_revenue_dispatch7(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_firstyear_revenue_dispatch7_fget, self->data_ptr);
}

static PyObject *
Outputs_get_firstyear_revenue_dispatch8(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_firstyear_revenue_dispatch8_fget, self->data_ptr);
}

static PyObject *
Outputs_get_firstyear_revenue_dispatch9(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_firstyear_revenue_dispatch9_fget, self->data_ptr);
}

static PyObject *
Outputs_get_flip_actual_irr(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_flip_actual_irr_fget, self->data_ptr);
}

static PyObject *
Outputs_get_flip_actual_year(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_flip_actual_year_fget, self->data_ptr);
}

static PyObject *
Outputs_get_flip_target_irr(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_flip_target_irr_fget, self->data_ptr);
}

static PyObject *
Outputs_get_flip_target_year(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_flip_target_year_fget, self->data_ptr);
}

static PyObject *
Outputs_get_ibi_fedtax_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_ibi_fedtax_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_ibi_statax_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_ibi_statax_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_ibi_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_ibi_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_ibi_total_fed(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_ibi_total_fed_fget, self->data_ptr);
}

static PyObject *
Outputs_get_ibi_total_oth(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_ibi_total_oth_fget, self->data_ptr);
}

static PyObject *
Outputs_get_ibi_total_sta(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_ibi_total_sta_fget, self->data_ptr);
}

static PyObject *
Outputs_get_ibi_total_uti(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_ibi_total_uti_fget, self->data_ptr);
}

static PyObject *
Outputs_get_issuance_of_equity(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_issuance_of_equity_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_fed_fixed_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_fed_fixed_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_fed_fixed_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_fed_fixed_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_fed_fixed_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_fed_fixed_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_fed_fixed_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_fed_fixed_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_fed_fixed_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_fed_fixed_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_fed_fixed_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_fed_fixed_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_fed_fixed_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_fed_fixed_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_fed_fixed_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_fed_fixed_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_fed_percent_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_fed_percent_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_fed_percent_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_fed_percent_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_fed_percent_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_fed_percent_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_fed_percent_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_fed_percent_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_fed_percent_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_fed_percent_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_fed_percent_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_fed_percent_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_fed_percent_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_fed_percent_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_fed_percent_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_fed_percent_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_sta_fixed_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_sta_fixed_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_sta_fixed_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_sta_fixed_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_sta_fixed_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_sta_fixed_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_sta_fixed_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_sta_fixed_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_sta_fixed_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_sta_fixed_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_sta_fixed_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_sta_fixed_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_sta_fixed_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_sta_fixed_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_sta_fixed_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_sta_fixed_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_sta_percent_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_sta_percent_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_sta_percent_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_sta_percent_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_sta_percent_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_sta_percent_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_sta_percent_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_sta_percent_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_sta_percent_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_sta_percent_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_sta_percent_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_sta_percent_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_sta_percent_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_sta_percent_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_disallow_sta_percent_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_disallow_sta_percent_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_fed_fixed_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_fed_fixed_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_fed_percent_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_fed_percent_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_fed_qual_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_fed_qual_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_fed_qual_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_fed_qual_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_fed_qual_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_fed_qual_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_fed_qual_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_fed_qual_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_fed_qual_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_fed_qual_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_fed_qual_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_fed_qual_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_fed_qual_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_fed_qual_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_fed_qual_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_fed_qual_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_sta_fixed_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_sta_fixed_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_sta_percent_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_sta_percent_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_sta_qual_custom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_sta_qual_custom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_sta_qual_macrs_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_sta_qual_macrs_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_sta_qual_macrs_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_sta_qual_macrs_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_sta_qual_sl_15(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_sta_qual_sl_15_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_sta_qual_sl_20(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_sta_qual_sl_20_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_sta_qual_sl_39(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_sta_qual_sl_39_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_sta_qual_sl_5(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_sta_qual_sl_5_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_sta_qual_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_sta_qual_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_total(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_total_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_total_fed(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_total_fed_fget, self->data_ptr);
}

static PyObject *
Outputs_get_itc_total_sta(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_itc_total_sta_fget, self->data_ptr);
}

static PyObject *
Outputs_get_lcoe_nom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_lcoe_nom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_lcoe_real(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_lcoe_real_fget, self->data_ptr);
}

static PyObject *
Outputs_get_lcoptc_fed_nom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_lcoptc_fed_nom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_lcoptc_fed_real(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_lcoptc_fed_real_fget, self->data_ptr);
}

static PyObject *
Outputs_get_lcoptc_sta_nom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_lcoptc_sta_nom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_lcoptc_sta_real(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_lcoptc_sta_real_fget, self->data_ptr);
}

static PyObject *
Outputs_get_lppa_nom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_lppa_nom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_lppa_real(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_lppa_real_fget, self->data_ptr);
}

static PyObject *
Outputs_get_nominal_discount_rate(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_nominal_discount_rate_fget, self->data_ptr);
}

static PyObject *
Outputs_get_npv_annual_costs(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_npv_annual_costs_fget, self->data_ptr);
}

static PyObject *
Outputs_get_npv_energy_nom(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_npv_energy_nom_fget, self->data_ptr);
}

static PyObject *
Outputs_get_npv_energy_real(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_npv_energy_real_fget, self->data_ptr);
}

static PyObject *
Outputs_get_npv_ppa_revenue(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_npv_ppa_revenue_fget, self->data_ptr);
}

static PyObject *
Outputs_get_ppa(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_ppa_fget, self->data_ptr);
}

static PyObject *
Outputs_get_ppa_escalation(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_ppa_escalation_fget, self->data_ptr);
}
...
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_ppa_price_fget, self->data_ptr);
}

static PyObject *
Outputs_get_present_value_fuel(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_present_value_fuel_fget, self->data_ptr);
}

static PyObject *
Outputs_get_present_value_insandproptax(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_present_value_insandproptax_fget, self->data_ptr);
}

static PyObject *
Outputs_get_present_value_oandm(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_present_value_oandm_fget, self->data_ptr);
}

static PyObject *
Outputs_get_present_value_oandm_nonfuel(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_present_value_oandm_nonfuel_fget, self->data_ptr);
}

static PyObject *
Outputs_get_prop_tax_assessed_value(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_prop_tax_assessed_value_fget, self->data_ptr);
}

static PyObject *
Outputs_get_purchase_of_property(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_purchase_of_property_fget, self->data_ptr);
}

static PyObject *
Outputs_get_salvage_value(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_salvage_value_fget, self->data_ptr);
}

static PyObject *
Outputs_get_size_of_equity(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_size_of_equity_fget, self->data_ptr);
}

static PyObject *
Outputs_get_sponsor_aftertax_development(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_sponsor_aftertax_development_fget, self->data_ptr);
}

static PyObject *
Outputs_get_sponsor_aftertax_equity(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_sponsor_aftertax_equity_fget, self->data_ptr);
}

static PyObject *
Outputs_get_sponsor_aftertax_irr(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_sponsor_aftertax_irr_fget, self->data_ptr);
}

static PyObject *
Outputs_get_sponsor_aftertax_npv(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_sponsor_aftertax_npv_fget, self->data_ptr);
}

static PyObject *
Outputs_get_sponsor_pretax_development(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_sponsor_pretax_development_fget, self->data_ptr);
}

static PyObject *
Outputs_get_sponsor_pretax_equity(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_sponsor_pretax_equity_fget, self->data_ptr);
}

static PyObject *
Outputs_get_sponsor_pretax_irr(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_sponsor_pretax_irr_fget, self->data_ptr);
}

static PyObject *
Outputs_get_sponsor_pretax_npv(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_sponsor_pretax_npv_fget, self->data_ptr);
}

static PyObject *
Outputs_get_tax_investor_aftertax_irr(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_tax_investor_aftertax_irr_fget, self->data_ptr);
}

static PyObject *
Outputs_get_tax_investor_aftertax_npv(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_tax_investor_aftertax_npv_fget, self->data_ptr);
}

static PyObject *
Outputs_get_tax_investor_pretax_irr(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_tax_investor_pretax_irr_fget, self->data_ptr);
}

static PyObject *
Outputs_get_tax_investor_pretax_npv(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_tax_investor_pretax_npv_fget, self->data_ptr);
}

static PyObject *
Outputs_get_wacc(OutputsObject *self, void *closure)
{
	return PySAM_float_getter(SAM_Equpartflip_Outputs_wacc_fget, self->data_ptr);
}
...
{"cf_feddepr_total", (getter)Outputs_get_cf_feddepr_total,(setter)0,
	"Federal tax depreciation [$], array.",
 	NULL},
...
{"cf_pretax_cashflow", (getter)Outputs_get_cf_pretax_cashflow,(setter)0,
	"Project pre-tax cash flow [$], array.",
 	NULL},
...
{"cf_project_me1ra", (getter)Outputs_get_cf_project_me1ra,(setter)0,
	"Reserve (increase)/decrease) major equipment reserve 1 [$], array.",
 	NULL},
...
{"cf_project_me2ra", (getter)Outputs_get_cf_project_me2ra,(setter)0,
	"Reserve (increase)/decrease) major equipment reserve 2 [$], array.",
 	NULL},
...
{"cf_project_me3ra", (getter)Outputs_get_cf_project_me3ra,(setter)0,
	"Reserve (increase)/decrease) major equipment reserve 3 [$], array.",
 	NULL},
...
{"cf_sponsor_aftertax_itc", (getter)Outputs_get_cf_sponsor_aftertax_itc,(setter)0,
	"Developer after-tax share of ITC [$], array.",
 	NULL},
...
{"cf_tax_investor_aftertax_cash", (getter)Outputs_get_cf_tax_investor_aftertax_cash,(setter)0,
	"Tax investor after-tax cash returns [$], array.",
 	NULL},
...
{"cf_tax_investor_aftertax_tax", (getter)Outputs_get_cf_tax_investor_aftertax_tax,(setter)0,
	"Tax investor shaer of tax benefit/(liability) [$], array.",
 	NULL},
...
{"depr_fedbas_after_itc_total", (getter)Outputs_get_depr_fedbas_after_itc_total,(setter)0,
	"Federal depreciation basis after ITC reduction [$], number.",
 	NULL},
...
{"depr_fedbas_first_year_bonus_total", (getter)Outputs_get_depr_fedbas_first_year_bonus_total,(setter)0,
	"Federal first year bonus depreciation [$], number.",
 	NULL},
...
{"depr_fedbas_itc_fed_reduction_total", (getter)Outputs_get_depr_fedbas_itc_fed_reduction_total,(setter)0,
	"Federal basis federal ITC reduciton [$], number.",
 	NULL},
...
{"depr_fedbas_itc_sta_reduction_total", (getter)Outputs_get_depr_fedbas_itc_sta_reduction_total,(setter)0,
	"Federal basis state ITC reduciton [$], number.",
 	NULL},
...
{"depr_fedbas_percent_qual_total", (getter)Outputs_get_depr_fedbas_percent_qual_total,(setter)0,
	"Federal percent of qualifying costs [%], number.",
 	NULL},
...
{"depr_fedbas_percent_total", (getter)Outputs_get_depr_fedbas_percent_total,(setter)0,
	"Federal percent of total depreciable basis [%], number.",
 	NULL},
...
{"depr_fedbas_prior_itc_total", (getter)Outputs_get_depr_fedbas_prior_itc_total,(setter)0,
	"Federal depreciation basis prior ITC reduction [$], number.",
 	NULL},
...
{"depr_fedbas_total", (getter)Outputs_get_depr_fedbas_total,(setter)0,
	"Federal depreciation basis [$], number.",
 	NULL},
...
{"depr_stabas_after_itc_total", (getter)Outputs_get_depr_stabas_after_itc_total,(setter)0,
	"State depreciation basis after ITC reduction [$], number.",
 	NULL},
...
{"depr_stabas_first_year_bonus_total", (getter)Outputs_get_depr_stabas_first_year_bonus_total,(setter)0,
	"State first year bonus depreciation [$], number.",
 	NULL},
...
{"depr_stabas_itc_fed_reduction_total", (getter)Outputs_get_depr_stabas_itc_fed_reduction_total,(setter)0,
	"State basis federal ITC reduciton [$], number.",
 	NULL},
...
{"depr_stabas_itc_sta_reduction_total", (getter)Outputs_get_depr_stabas_itc_sta_reduction_total,(setter)0,
	"State basis state ITC reduciton [$], number.",
 	NULL},
...
{"depr_stabas_percent_qual_total", (getter)Outputs_get_depr_stabas_percent_qual_total,(setter)0,
	"State percent of qualifying costs [%], number.",
 	NULL},
...
{"depr_stabas_percent_total", (getter)Outputs_get_depr_stabas_percent_total,(setter)0,
	"State percent of total depreciable basis [%], number.",
 	NULL},
...
{"depr_stabas_prior_itc_total", (getter)Outputs_get_depr_stabas_prior_itc_total,(setter)0,
	"State depreciation basis prior ITC reduction [$], number.",
 	NULL},
...
{"itc_fed_qual_total", (getter)Outputs_get_itc_fed_qual_total,(setter)0,
	"Federal ITC adj qualifying costs [$], number.",
 	NULL},
...
{"itc_sta_qual_total", (getter)Outputs_get_itc_sta_qual_total,(setter)0,
	"State ITC adj qualifying costs [$], number.",
 	NULL},
...
{"purchase_of_property", (getter)Outputs_get_purchase_of_property,(setter)0,
	"Purchase of property cost [$], number.",
 	NULL},
...
{"sponsor_aftertax_equity", (getter)Outputs_get_sponsor_aftertax_equity,(setter)0,
	"Developer after-tax equity investment [$], number.",
 	NULL},
...
{"sponsor_pretax_equity", (getter)Outputs_get_sponsor_pretax_equity,(setter)0,
	"Developer pre-tax equity investment [$], number.",
 	NULL},
...
EqupartflipModule_exec(PyObject *m)
{
	...
	/// Add the Common type object to Equpartflip_Type
	...
	/// Add the DHF type object to Equpartflip_Type
