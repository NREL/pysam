...
static PyObject *
Outputs_get_cf_fed_taxable_incentive_income(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_cf_sta_taxable_incentive_income(OutputsObject *self, void *closure)
{
