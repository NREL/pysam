...
{"Flow_type", (getter)TowerAndReceiver_get_Flow_type,(setter)TowerAndReceiver_set_Flow_type,
	PyDoc_STR("type: Float\n\nReceiver flow pattern: see figure on SAM Receiver page\n\n*Required*: True"),
 	NULL},
...
{"CT", (getter)RankineCycle_get_CT,(setter)RankineCycle_set_CT,
	PyDoc_STR("type: Float\n\nCondensor type: 1=evaporative, 2=air, 3=hybrid\n\n*Required*: set to 0 if not provided."),
 	NULL},
...
static PyTypeObject TcsmoltenSalt_Type = {
		...
		0,                          /*tp_as_buffer*/
		Py_TPFLAGS_DEFAULT,         /*tp_flags*/
		"Wrapper for `cmod_tcsmolten_salt.cpp <https://github.com/NREL/ssc/blob/develop/ssc/cmod_tcsmolten_salt.cpp>`_",        /*tp_doc*/
		0,                          /*tp_traverse*/
		0,                          /*tp_clear*/
		0,                          /*tp_richcompare*/
		0,                          /*tp_weaklistofnset*/
...
static PyMethodDef TcsmoltenSaltModule_methods[] = {
		...
		{"default",             TcsmoltenSalt_default,         METH_VARARGS,
				PyDoc_STR("default(config) -> new TcsmoltenSalt object with financial model-specific default attributes\n"
