...
static PyTypeObject Pvwattsv5_Type = {
		...
		0,                          /*tp_as_buffer*/
		Py_TPFLAGS_DEFAULT,         /*tp_flags*/
		"Wrapper for `cmod_pvwattsv5.cpp <https://github.com/NREL/ssc/blob/develop/ssc/cmod_pvwattsv5.cpp>`_",        /*tp_doc*/
		0,                          /*tp_traverse*/
		0,                          /*tp_clear*/
		0,                          /*tp_richcompare*/
		0,                          /*tp_weaklistofnset*/
...
static PyMethodDef Pvwattsv5Module_methods[] = {
		...
		{"default",             Pvwattsv5_default,         METH_VARARGS,
				PyDoc_STR("default(config) -> new Pvwattsv5 object with financial model-specific default attributes\n"
