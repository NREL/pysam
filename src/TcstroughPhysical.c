...
{"pc_config", (getter)Powerblock_get_pc_config,(setter)Powerblock_set_pc_config,
	PyDoc_STR("type: Float\n\n0: Steam Rankine (224), 1: user defined [-]\n\n*Constraints*: INTEGER\n\n*Required*: set to 0 if not provided."),
 	NULL},
...
static PyTypeObject TcstroughPhysical_Type = {
		...
		0,                          /*tp_as_buffer*/
		Py_TPFLAGS_DEFAULT,         /*tp_flags*/
		"Wrapper for `cmod_tcstrough_physical.cpp <https://github.com/NREL/ssc/blob/develop/ssc/cmod_tcstrough_physical.cpp>`_",        /*tp_doc*/
		0,                          /*tp_traverse*/
		0,                          /*tp_clear*/
		0,                          /*tp_richcompare*/
		0,                          /*tp_weaklistofnset*/
...
static PyMethodDef TcstroughPhysicalModule_methods[] = {
		...
		{"default",             TcstroughPhysical_default,         METH_VARARGS,
				PyDoc_STR("default(config) -> new TcstroughPhysical object with financial model-specific default attributes\n"
