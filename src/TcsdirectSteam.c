...
{"fossil_mode", (getter)DsgController_get_fossil_mode,(setter)DsgController_set_fossil_mode,
	PyDoc_STR("type: Float\n\nFossil model: 1=Normal, 2=Supplemental [-]\n\n*Constraints*: INTEGER\n\n*Required*: True"),
 	NULL},
...
static PyTypeObject TcsdirectSteam_Type = {
		...
		0,                          /*tp_as_buffer*/
		Py_TPFLAGS_DEFAULT,         /*tp_flags*/
		"Wrapper for `cmod_tcsdirect_steam.cpp <https://github.com/NREL/ssc/blob/develop/ssc/cmod_tcsdirect_steam.cpp>`_",        /*tp_doc*/
		0,                          /*tp_traverse*/
		0,                          /*tp_clear*/
		0,                          /*tp_richcompare*/
		0,                          /*tp_weaklistofnset*/
...
static PyMethodDef TcsdirectSteamModule_methods[] = {
		...
		{"default",             TcsdirectSteam_default,         METH_VARARGS,
				PyDoc_STR("default(config) -> new TcsdirectSteam object with financial model-specific default attributes\n"
