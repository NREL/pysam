...
TcsdirectSteam_default(PyObject *self, PyObject *args)
{
	...
	PySAM_load_defaults((PyObject*)rv, rv->x_attr, rv->data_ptr, "TcsdirectSteam", fin);
...
static PyMethodDef TcsdirectSteamModule_methods[] = {
		...
		{"wrap",             TcsdirectSteam_wrap,         METH_VARARGS,
				PyDoc_STR("wrap(ssc_data_t) -> new TcsdirectSteam object around existing PySSC data")},
		{NULL,              NULL}           /* sentinel */
};
