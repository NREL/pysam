...
typedef struct {
	PyObject_HEAD
	SAM_Sco2CspSystem   data_ptr;
} OffDesignInputsObject;

static PyTypeObject OffDesignInputs_Type;

static PyObject *
OffDesignInputs_new(SAM_Sco2CspSystem data_ptr)
{
	PyObject* new_obj = OffDesignInputs_Type.tp_alloc(&OffDesignInputs_Type,0);

	OffDesignInputsObject* OffDesignInputs_obj = (OffDesignInputsObject*)new_obj;

	OffDesignInputs_obj->data_ptr = data_ptr;

	return new_obj;
}

/* OffDesignInputs methods */

static PyObject *
OffDesignInputs_assign(OffDesignInputsObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_assign_from_dict(self->data_ptr, dict, "Sco2CspSystem", "OffDesignInputs")){
		return NULL;
	}
...
static PyObject *
OffDesignInputs_export(OffDesignInputsObject *self, PyObject *args)
{
	PyTypeObject* tp = &OffDesignInputs_Type;
	PyObject* dict = PySAM_export_to_dict((PyObject *) self, tp);
	return dict;
}

static PyMethodDef OffDesignInputs_methods[] = {
		{"assign",            (PyCFunction)OffDesignInputs_assign,  METH_VARARGS,
			PyDoc_STR("assign() -> None\n Assign attributes from dictionary\n\n``OffDesignInputs_vals = { var: val, ...}``")},
		{"export",            (PyCFunction)OffDesignInputs_export,  METH_VARARGS,
			PyDoc_STR("export() -> dict\n Export attributes into dictionary")},
		{NULL,              NULL}           /* sentinel */
};

static PyObject *
OffDesignInputs_get_is_gen_od_polynomials(OffDesignInputsObject *self, void *closure)
{
	return PySAM_double_getter(SAM_Sco2CspSystem_OffDesignInputs_is_gen_od_polynomials_nget, self->data_ptr);
}

static int
OffDesignInputs_set_is_gen_od_polynomials(OffDesignInputsObject *self, PyObject *value, void *closure)
{
	return PySAM_double_setter(value, SAM_Sco2CspSystem_OffDesignInputs_is_gen_od_polynomials_nset, self->data_ptr);
}

static PyObject *
OffDesignInputs_get_od_P_mc_in_sweep(OffDesignInputsObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Sco2CspSystem_OffDesignInputs_od_P_mc_in_sweep_aget, self->data_ptr);
}

static int
OffDesignInputs_set_od_P_mc_in_sweep(OffDesignInputsObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_Sco2CspSystem_OffDesignInputs_od_P_mc_in_sweep_aset, self->data_ptr);
}

static PyObject *
OffDesignInputs_get_od_T_t_in_mode(OffDesignInputsObject *self, void *closure)
{
	return PySAM_double_getter(SAM_Sco2CspSystem_OffDesignInputs_od_T_t_in_mode_nget, self->data_ptr);
}

static int
OffDesignInputs_set_od_T_t_in_mode(OffDesignInputsObject *self, PyObject *value, void *closure)
{
	return PySAM_double_setter(value, SAM_Sco2CspSystem_OffDesignInputs_od_T_t_in_mode_nset, self->data_ptr);
}

static PyObject *
OffDesignInputs_get_od_cases(OffDesignInputsObject *self, void *closure)
{
	return PySAM_matrix_getter(SAM_Sco2CspSystem_OffDesignInputs_od_cases_mget, self->data_ptr);
}

static int
OffDesignInputs_set_od_cases(OffDesignInputsObject *self, PyObject *value, void *closure)
{
		return PySAM_matrix_setter(value, SAM_Sco2CspSystem_OffDesignInputs_od_cases_mset, self->data_ptr);
}

static PyObject *
OffDesignInputs_get_od_set_control(OffDesignInputsObject *self, void *closure)
{
	return PySAM_matrix_getter(SAM_Sco2CspSystem_OffDesignInputs_od_set_control_mget, self->data_ptr);
}

static int
OffDesignInputs_set_od_set_control(OffDesignInputsObject *self, PyObject *value, void *closure)
{
		return PySAM_matrix_setter(value, SAM_Sco2CspSystem_OffDesignInputs_od_set_control_mset, self->data_ptr);
}

static PyGetSetDef OffDesignInputs_getset[] = {
{"is_gen_od_polynomials", (getter)OffDesignInputs_get_is_gen_od_polynomials,(setter)OffDesignInputs_set_is_gen_od_polynomials,
	PyDoc_STR("*float*: Generate off-design polynomials for Generic CSP models? 1 = Yes, 0 = No\n\n*Required*: If not provided, assumed to be 0"),
 	NULL},
{"od_P_mc_in_sweep", (getter)OffDesignInputs_get_od_P_mc_in_sweep,(setter)OffDesignInputs_set_od_P_mc_in_sweep,
	PyDoc_STR("*sequence*: Columns: T_htf_C, m_dot_htf_ND, T_amb_C, f_N_rc (=1 use design, <0, frac_des = abs(input), f_N_mc (=1 use design, <0, frac_des = abs(input), PHX_f_dP (=1 use design, <0 = abs(input)"),
 	NULL},
{"od_T_t_in_mode", (getter)OffDesignInputs_get_od_T_t_in_mode,(setter)OffDesignInputs_set_od_T_t_in_mode,
	PyDoc_STR("*float*: 0: model solves co2/HTF PHX od model to calculate turbine inlet temp, 1: model sets turbine inlet temp to HTF hot temp\n\n*Required*: If not provided, assumed to be 0"),
 	NULL},
{"od_cases", (getter)OffDesignInputs_get_od_cases,(setter)OffDesignInputs_set_od_cases,
	PyDoc_STR("*sequence[sequence]*: olumns: T_htf_C, m_dot_htf_ND, T_amb_C, f_N_rc (=1 use design, =0 optimize, <0, frac_des = abs(input), f_N_mc (=1 use design, =0 Coptimize, <0, frac_des = abs(input), PHX_f_dP (=1 use design, <0 = abs(input), Rows: cases"),
 	NULL},
{"od_set_control", (getter)OffDesignInputs_get_od_set_control,(setter)OffDesignInputs_set_od_set_control,
...
static PyTypeObject OffDesignInputs_Type = {
		 ...
		 * to be portable to Windows without using C++. */
		PyVarObject_HEAD_INIT(NULL, 0)
		"Sco2CspSystem.OffDesignInputs",             /*tp_name*/
		sizeof(OffDesignInputsObject),          /*tp_basicsize*/
		0,                          /*tp_itemsize*/
		/* methods */
		0,    /*tp_dealloc*/
		0,                          /*tp_print*/
		...
		0,                          /*tp_iter*/
		0,                          /*tp_iternext*/
		OffDesignInputs_methods,         /*tp_methods*/
		0,                          /*tp_members*/
		OffDesignInputs_getset,          /*tp_getset*/
		0,                          /*tp_base*/
		0,                          /*tp_dict*/
		0,                          /*tp_descr_get*/
		0,                          /*tp_descr_set*/
...
static PyObject *
Outputs_get_HTR_HP_T_in_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_HTR_HP_deltaP_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_HTR_LP_T_out_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_HTR_LP_deltaP_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_HTR_min_dT_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_IP_cooler_W_dot_fan_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_LP_cooler_T_in_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_LP_cooler_W_dot_fan_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_LP_cooler_co2_deltaP_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_LP_cooler_in_isen_deltah_to_P_mc_out_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_LP_cooler_rho_in_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_LTR_HP_T_out_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_LTR_HP_deltaP_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_LTR_LP_deltaP_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_LTR_min_dT_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_P_co2_PHX_in_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_P_comp_in_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_P_mc_out_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_Q_dot_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_T_amb_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_T_co2_PHX_in_od(OutputsObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Sco2CspSystem_Outputs_T_co2_PHX_in_od_aget, self->data_ptr);
}

static PyObject *
Outputs_get_T_co2_PHX_out_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_T_htf_cold_od(OutputsObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Sco2CspSystem_Outputs_T_htf_cold_od_aget, self->data_ptr);
}

static PyObject *
Outputs_get_T_htf_hot_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_T_mc_in_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_W_dot_net_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_c_tot_W_dot_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_cooler_tot_W_dot_fan_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_deltaT_HTF_PHX_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_eff_HTR_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_eff_LTR_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_eta_thermal_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_m_dot_co2_full_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_m_dot_htf_fracs(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_mc_N_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_mc_T_out_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_mc_W_dot_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_mc_eta_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_mc_eta_stages_od(OutputsObject *self, void *closure)
{
	return PySAM_matrix_getter(SAM_Sco2CspSystem_Outputs_mc_eta_stages_od_mget, self->data_ptr);
}

static PyObject *
Outputs_get_mc_f_bypass_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_mc_ideal_spec_work_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_mc_m_dot_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_mc_phi_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_mc_psi_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_mc_rho_in_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_pc_N_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_pc_P_in_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_pc_T_in_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_pc_W_dot_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_pc_eta_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_pc_eta_stages_od(OutputsObject *self, void *closure)
{
	return PySAM_matrix_getter(SAM_Sco2CspSystem_Outputs_pc_eta_stages_od_mget, self->data_ptr);
}

static PyObject *
Outputs_get_pc_f_bypass_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_pc_ideal_spec_work_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_pc_m_dot_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_pc_phi_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_pc_rho_in_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_q_dot_HTR_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_q_dot_LTR_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_rc_N_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_rc_P_in_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_rc_P_out_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_rc_T_in_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_rc_T_out_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_rc_W_dot_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_rc_eta_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_rc_eta_stages_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_rc_m_dot_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_rc_phi_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_rc_psi_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_rc_tip_ratio_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_recomp_frac_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_sim_time_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_t_N_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_t_P_in_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_t_P_out_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_t_T_out_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_t_W_dot_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_t_eta_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_t_m_dot_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_t_nu_od(OutputsObject *self, void *closure)
{
...
static PyObject *
Outputs_get_t_tip_ratio_od(OutputsObject *self, void *closure)
{
...
{"od_code", (getter)Outputs_get_od_code,(setter)0,
	PyDoc_STR("*sequence*: Off-design Diagnostic info [-]"),
 	NULL},
...
static Sco2CspSystemObject *
newSco2CspSystemObject(void* data_ptr)
{
	Sco2CspSystemObject *self;
	self = PyObject_New(Sco2CspSystemObject, &Sco2CspSystem_Type);

	PySAM_TECH_ATTR("Sco2CspSystem", SAM_Sco2CspSystem_construct)
	...
	PyObject* OffDesignInputs_obj = OffDesignInputs_new(self->data_ptr);
	PyDict_SetItemString(attr_dict, "OffDesignInputs", OffDesignInputs_obj);
	Py_DECREF(OffDesignInputs_obj);
...
static void
Sco2CspSystem_dealloc(Sco2CspSystemObject *self)
{
	Py_XDECREF(self->x_attr);
	SAM_Sco2CspSystem_destruct(self->data_ptr);
	PyObject_Del(self);
}


static PyObject *
Sco2CspSystem_execute(Sco2CspSystemObject *self, PyObject *args)
{
	int verbosity = 0;
...
static PyObject *
Sco2CspSystem_assign(Sco2CspSystemObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
...
static PyObject *
Sco2CspSystem_export(Sco2CspSystemObject *self, PyObject *args)
{
...
static PyObject *
Sco2CspSystem_getattro(Sco2CspSystemObject *self, PyObject *name)
{
	return PySAM_get_attr((PyObject*) self, (PyObject*) self->x_attr, name);
}

static int
Sco2CspSystem_setattr(Sco2CspSystemObject *self, const char *name, PyObject *v)
{
...
static PyTypeObject Sco2CspSystem_Type = {
		...
		sizeof(Sco2CspSystemObject),/*tp_basicsize*/
		0,                          /*tp_itemsize*/
		/* methods */
...
Sco2CspSystemModule_exec(PyObject *m)
{
	...
	/// Add the OffDesignInputs type object to Sco2CspSystem_Type
	if (PyType_Ready(&OffDesignInputs_Type) < 0) { goto fail; }
	PyDict_SetItemString(Sco2CspSystem_Type.tp_dict,
				"OffDesignInputs",
				(PyObject*)&OffDesignInputs_Type);
	Py_DECREF(&OffDesignInputs_Type);
