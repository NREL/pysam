...
{
	return PySAM_float_getter(SAM_Saleleaseback_SystemOutput_system_capacity_fget, self->data_ptr);
}

static int
SystemOutput_set_system_capacity(SystemOutputObject *self, PyObject *value, void *closure)
{
	return PySAM_float_setter(value, SAM_Saleleaseback_SystemOutput_system_capacity_fset, self->data_ptr);
}
