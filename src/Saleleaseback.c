...
Saleleaseback_default(PyObject *self, PyObject *args)
{
	...
	PySAM_load_defaults((PyObject*)rv, rv->x_attr, rv->data_ptr, "Saleleaseback", fin);
...
static PyMethodDef SaleleasebackModule_methods[] = {
		...
		{"wrap",             Saleleaseback_wrap,         METH_VARARGS,
				PyDoc_STR("wrap(ssc_data_t) -> new Saleleaseback object around existing PySSC data")},
		{NULL,              NULL}           /* sentinel */
};
...
SaleleasebackModule_exec(PyObject *m)
{
	...
	/// Add the AdjustmentFactors type object to Saleleaseback_Type
	PyObject* AdjustmentFactorsModule = PyImport_ImportModule("AdjustmentFactors");
