...
TroughPhysicalProcessHeat is a wrapper for the SSC compute module `cmod_trough_physical_process_heat.cpp <https://github.com/NREL/ssc/blob/develop/ssc/cmod_trough_physical_process_heat.cpp>`_
