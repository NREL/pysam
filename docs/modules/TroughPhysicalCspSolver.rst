...
TroughPhysicalCspSolver is a wrapper for the SSC compute module `cmod_trough_physical_csp_solver.cpp <https://github.com/NREL/ssc/blob/develop/ssc/cmod_trough_physical_csp_solver.cpp>`_
