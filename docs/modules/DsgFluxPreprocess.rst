...
DsgFluxPreprocess is a wrapper for the SSC compute module `cmod_dsg_flux_preprocess.cpp <https://github.com/NREL/ssc/blob/develop/ssc/cmod_dsg_flux_preprocess.cpp>`_
