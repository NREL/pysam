...
TcstroughPhysical is a wrapper for the SSC compute module `cmod_tcstrough_physical.cpp <https://github.com/NREL/ssc/blob/develop/ssc/cmod_tcstrough_physical.cpp>`_
