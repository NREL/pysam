...
static PyObject *
SingleDiodeModel_replace(VarGroupObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Singlediodeparams", "SingleDiodeModel")){
		return NULL;
	}
...
Outputs_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Singlediodeparams", "Outputs")){
		return NULL;
	}
...
static PyObject *
Singlediodeparams_get_data_ptr(CmodObject *self, PyObject *args)
{
...
static PyObject *
Singlediodeparams_set_data_ptr(CmodObject *self, PyObject *args)
{
...
static PyObject *
Singlediodeparams_replace(CmodObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_replace_from_nested_dict((PyObject*)self, self->x_attr, self->data_ptr, dict, "Singlediodeparams"))
		return NULL;
...
static PyObject *
Singlediodeparams_unassign(CmodObject *self, PyObject *args)
{
...
static PyMethodDef Singlediodeparams_methods[] = {
		...
		{"get_data_ptr",           (PyCFunction)Singlediodeparams_get_data_ptr,  METH_VARARGS,
				PyDoc_STR("get_data_ptr() -> Pointer\n Get ssc_data_t pointer")},
		{"set_data_ptr",           (PyCFunction)Singlediodeparams_set_data_ptr,  METH_VARARGS,
		...
		{"replace",            (PyCFunction)Singlediodeparams_replace,  METH_VARARGS,
		...
		{"unassign",          (PyCFunction)Singlediodeparams_unassign, METH_VARARGS,
