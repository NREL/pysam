...
static PyObject *
GenericSystem_set_data_ptr(CmodObject *self, PyObject *args)
{
	...
	VarGroupObject* Plant_obj = (VarGroupObject*)PyDict_GetItemString(self->x_attr, "Plant");
	Plant_obj->data_ptr = (void*)ptr;
