...
static PyObject *
WindBos_replace(VarGroupObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Windbos", "WindBos")){
		return NULL;
	}
...
static PyMethodDef WindBos_methods[] = {
		...
		{"replace",            (PyCFunction)WindBos_replace,  METH_VARARGS,
...
Outputs_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Windbos", "Outputs")){
		return NULL;
	}
...
static PyObject *
Windbos_get_data_ptr(CmodObject *self, PyObject *args)
{
...
static PyObject *
Windbos_set_data_ptr(CmodObject *self, PyObject *args)
{
	...
	VarGroupObject* WindBos_obj = (VarGroupObject*)PyDict_GetItemString(self->x_attr, "WindBos");
	WindBos_obj->data_ptr = (void*)ptr;
...
static PyObject *
Windbos_replace(CmodObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_replace_from_nested_dict((PyObject*)self, self->x_attr, self->data_ptr, dict, "Windbos"))
		return NULL;
...
static PyObject *
Windbos_unassign(CmodObject *self, PyObject *args)
{
...
static PyMethodDef Windbos_methods[] = {
		...
		{"unassign",          (PyCFunction)Windbos_unassign, METH_VARARGS,
				PyDoc_STR("unassign(name) -> None\n Unassign a value in any of the variable groups.")},
		{"get_data_ptr",           (PyCFunction)Windbos_get_data_ptr,  METH_VARARGS,
				PyDoc_STR("get_data_ptr() -> Pointer\n Get ssc_data_t pointer")},
		{"set_data_ptr",           (PyCFunction)Windbos_set_data_ptr,  METH_VARARGS,
