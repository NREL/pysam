...
{
	return PySAM_double_getter(SAM_Utilityrate4_Outputs_utility_bill_w_sys_year1_nget, self->data_ptr);
}
...
{
	return PySAM_double_getter(SAM_Utilityrate4_Outputs_utility_bill_wo_sys_year1_nget, self->data_ptr);
}
...
static PyObject *
Utilityrate4_get_data_ptr(CmodObject *self, PyObject *args)
{
...
static PyMethodDef Utilityrate4_methods[] = {
		...
		{"get_data_ptr",           (PyCFunction)Utilityrate4_get_data_ptr,  METH_VARARGS,
