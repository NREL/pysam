...
static PyObject *
PvGetShadeLossMpp_set_data_ptr(CmodObject *self, PyObject *args)
{
	...
	VarGroupObject* PVShadeLossDB_obj = (VarGroupObject*)PyDict_GetItemString(self->x_attr, "PVShadeLossDB");
	PVShadeLossDB_obj->data_ptr = (void*)ptr;
...
static PyObject *
PvGetShadeLossMpp_unassign(CmodObject *self, PyObject *args)
{
...
static PyMethodDef PvGetShadeLossMpp_methods[] = {
		...
		{"unassign",          (PyCFunction)PvGetShadeLossMpp_unassign, METH_VARARGS,
				PyDoc_STR("unassign(name) -> None\n Unassign a value in any of the variable groups.")},
		{"get_data_ptr",           (PyCFunction)PvGetShadeLossMpp_get_data_ptr,  METH_VARARGS,
				PyDoc_STR("get_data_ptr() -> Pointer\n Get ssc_data_t pointer")},
		{"set_data_ptr",           (PyCFunction)PvGetShadeLossMpp_set_data_ptr,  METH_VARARGS,
