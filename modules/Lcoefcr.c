...
SimpleLCOE_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Lcoefcr", "SimpleLCOE")){
		return NULL;
	}
...
Outputs_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Lcoefcr", "Outputs")){
		return NULL;
	}
...
static PyObject *
Lcoefcr_replace(CmodObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_replace_from_nested_dict((PyObject*)self, self->x_attr, self->data_ptr, dict, "Lcoefcr"))
		return NULL;
...
static PyObject *
Lcoefcr_unassign(CmodObject *self, PyObject *args)
{
