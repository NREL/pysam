...
static PyObject *
EtesElectricResistance_set_data_ptr(CmodObject *self, PyObject *args)
{
	...
	VarGroupObject* SystemCost_obj = (VarGroupObject*)PyDict_GetItemString(self->x_attr, "SystemCost");
	SystemCost_obj->data_ptr = (void*)ptr;
...
static PyMethodDef EtesElectricResistance_methods[] = {
		...
		{"set_data_ptr",           (PyCFunction)EtesElectricResistance_set_data_ptr,  METH_VARARGS,
