...
Common_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "DsgFluxPreprocess", "Common")){
		return NULL;
	}
...
Outputs_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "DsgFluxPreprocess", "Outputs")){
		return NULL;
	}
...
static PyObject *
DsgFluxPreprocess_replace(CmodObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_replace_from_nested_dict((PyObject*)self, self->x_attr, self->data_ptr, dict, "DsgFluxPreprocess"))
		return NULL;
...
static PyObject *
DsgFluxPreprocess_unassign(CmodObject *self, PyObject *args)
{
...
static PyMethodDef DsgFluxPreprocess_methods[] = {
		...
		{"replace",            (PyCFunction)DsgFluxPreprocess_replace,  METH_VARARGS,
		...
		{"unassign",          (PyCFunction)DsgFluxPreprocess_unassign, METH_VARARGS,
