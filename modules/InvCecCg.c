...
Common_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "InvCecCg", "Common")){
		return NULL;
	}
...
Outputs_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "InvCecCg", "Outputs")){
		return NULL;
	}
...
static PyObject *
InvCecCg_set_data_ptr(CmodObject *self, PyObject *args)
{
...
static PyObject *
InvCecCg_replace(CmodObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_replace_from_nested_dict((PyObject*)self, self->x_attr, self->data_ptr, dict, "InvCecCg"))
		return NULL;
...
static PyObject *
InvCecCg_unassign(CmodObject *self, PyObject *args)
{
...
static PyMethodDef InvCecCg_methods[] = {
		...
		{"set_data_ptr",           (PyCFunction)InvCecCg_set_data_ptr,  METH_VARARGS,
