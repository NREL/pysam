...
SystemCosts_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "CbConstructionFinancing", "SystemCosts")){
		return NULL;
	}
...
FinancialParameters_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "CbConstructionFinancing", "FinancialParameters")){
		return NULL;
	}
...
Outputs_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "CbConstructionFinancing", "Outputs")){
		return NULL;
	}
...
static PyObject *
CbConstructionFinancing_get_data_ptr(CmodObject *self, PyObject *args)
{
...
static PyObject *
CbConstructionFinancing_set_data_ptr(CmodObject *self, PyObject *args)
{
...
static PyObject *
CbConstructionFinancing_replace(CmodObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_replace_from_nested_dict((PyObject*)self, self->x_attr, self->data_ptr, dict, "CbConstructionFinancing"))
		return NULL;
...
static PyObject *
CbConstructionFinancing_unassign(CmodObject *self, PyObject *args)
{
...
static PyMethodDef CbConstructionFinancing_methods[] = {
		...
		{"replace",            (PyCFunction)CbConstructionFinancing_replace,  METH_VARARGS,
		...
		{"unassign",          (PyCFunction)CbConstructionFinancing_unassign, METH_VARARGS,
				PyDoc_STR("unassign(name) -> None\n Unassign a value in any of the variable groups.")},
		{"get_data_ptr",           (PyCFunction)CbConstructionFinancing_get_data_ptr,  METH_VARARGS,
				PyDoc_STR("get_data_ptr() -> Pointer\n Get ssc_data_t pointer")},
		{"set_data_ptr",           (PyCFunction)CbConstructionFinancing_set_data_ptr,  METH_VARARGS,
...
CbConstructionFinancing_default(PyObject *self, PyObject *args)
{
	...
	rv->data_owner_ptr = NULL;
	if (PySAM_load_defaults((PyObject*)rv, rv->x_attr, rv->data_ptr, "CbConstructionFinancing", def) < 0) {
		CbConstructionFinancing_dealloc(rv);
		return NULL;
	}
	return (PyObject *)rv;
}
