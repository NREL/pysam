...
Common_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Utilityrate2", "Common")){
		return NULL;
	}
...
AnnualOutput_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Utilityrate2", "AnnualOutput")){
		return NULL;
	}
...
Outputs_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Utilityrate2", "Outputs")){
		return NULL;
	}
...
static PyObject *
Utilityrate2_get_data_ptr(CmodObject *self, PyObject *args)
{
...
static PyObject *
Utilityrate2_replace(CmodObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_replace_from_nested_dict((PyObject*)self, self->x_attr, self->data_ptr, dict, "Utilityrate2"))
		return NULL;
...
static PyObject *
Utilityrate2_unassign(CmodObject *self, PyObject *args)
{
...
static PyMethodDef Utilityrate2_methods[] = {
		...
		{"unassign",          (PyCFunction)Utilityrate2_unassign, METH_VARARGS,
