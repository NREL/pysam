...
static PyObject *
MhkWave_set_data_ptr(CmodObject *self, PyObject *args)
{
	...
	VarGroupObject* MHKWave_obj = (VarGroupObject*)PyDict_GetItemString(self->x_attr, "MHKWave");
	MHKWave_obj->data_ptr = (void*)ptr;
...
static PyMethodDef MhkWave_methods[] = {
		...
		{"set_data_ptr",           (PyCFunction)MhkWave_set_data_ptr,  METH_VARARGS,
