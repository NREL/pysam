...
Dish_new(SAM_Tcsdish data_ptr)
{
	...
	VarGroupObject* Dish_obj = (VarGroupObject*)new_obj;

	Dish_obj->data_ptr = (SAM_table)data_ptr;
...
static PyObject *
Dish_assign(VarGroupObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
...
static PyObject *
Dish_get_system_capacity(VarGroupObject *self, void *closure)
{
	return PySAM_double_getter(SAM_Tcsdish_Dish_system_capacity_nget, self->data_ptr);
}

static int
Dish_set_system_capacity(VarGroupObject *self, PyObject *value, void *closure)
{
...
Type295_new(SAM_Tcsdish data_ptr)
{
	...
	VarGroupObject* Type295_obj = (VarGroupObject*)new_obj;

	Type295_obj->data_ptr = (SAM_table)data_ptr;
...
static PyObject *
Type295_assign(VarGroupObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
...
Type296_new(SAM_Tcsdish data_ptr)
{
	...
	VarGroupObject* Type296_obj = (VarGroupObject*)new_obj;

	Type296_obj->data_ptr = (SAM_table)data_ptr;
...
static PyObject *
Type296_assign(VarGroupObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
...
Type297_new(SAM_Tcsdish data_ptr)
{
	...
	VarGroupObject* Type297_obj = (VarGroupObject*)new_obj;

	Type297_obj->data_ptr = (SAM_table)data_ptr;
...
static PyObject *
Type297_assign(VarGroupObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
...
Type298_new(SAM_Tcsdish data_ptr)
{
	...
	VarGroupObject* Type298_obj = (VarGroupObject*)new_obj;

	Type298_obj->data_ptr = (SAM_table)data_ptr;
...
static PyObject *
Type298_assign(VarGroupObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
...
static PyObject *
Outputs_get_net_power(VarGroupObject *self, void *closure)
{
...
static PyObject *
Tcsdish_execute(CmodObject *self, PyObject *args)
{
	int verbosity = 0;
...
static PyObject *
Tcsdish_assign(CmodObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
...
static PyObject *
Tcsdish_unassign(CmodObject *self, PyObject *args)
{
...
static PyMethodDef Tcsdish_methods[] = {
		...
		{"unassign",          (PyCFunction)Tcsdish_unassign, METH_VARARGS,
				PyDoc_STR("unassign(name) -> None\n Unassign a value in any of the variable groups.")},
		{NULL,              NULL}           /* sentinel */
};

static PyObject *
Tcsdish_getattro(CmodObject *self, PyObject *name)
{
	return PySAM_get_attr((PyObject*) self, (PyObject*) self->x_attr, name);
}

static int
Tcsdish_setattr(CmodObject *self, const char *name, PyObject *v)
{
...
static PyObject *
Tcsdish_from_existing(PyObject *self, PyObject *args)
{
	CmodObject *rv;
	PyObject * module = 0;
	char* def = 0;
...
static PyMethodDef TcsdishModule_methods[] = {
		...
		{"from_existing",   Tcsdish_from_existing,        METH_VARARGS,
				PyDoc_STR("from_existing(data, optional config) -> Tcsdish\n\nShare underlying data with an existing PySAM class. If config provided, default attributes are loaded otherwise.")},
		{NULL,              NULL}           /* sentinel */
};
