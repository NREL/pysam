...
Hce_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "CbEmpiricalHceHeatLoss", "Hce")){
		return NULL;
	}
...
Outputs_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "CbEmpiricalHceHeatLoss", "Outputs")){
		return NULL;
	}
...
static PyObject *
CbEmpiricalHceHeatLoss_get_data_ptr(CmodObject *self, PyObject *args)
{
...
static PyObject *
CbEmpiricalHceHeatLoss_set_data_ptr(CmodObject *self, PyObject *args)
{
...
static PyObject *
CbEmpiricalHceHeatLoss_replace(CmodObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_replace_from_nested_dict((PyObject*)self, self->x_attr, self->data_ptr, dict, "CbEmpiricalHceHeatLoss"))
		return NULL;
...
static PyObject *
CbEmpiricalHceHeatLoss_unassign(CmodObject *self, PyObject *args)
{
...
static PyMethodDef CbEmpiricalHceHeatLoss_methods[] = {
		...
		{"replace",            (PyCFunction)CbEmpiricalHceHeatLoss_replace,  METH_VARARGS,
		...
		{"unassign",          (PyCFunction)CbEmpiricalHceHeatLoss_unassign, METH_VARARGS,
				PyDoc_STR("unassign(name) -> None\n Unassign a value in any of the variable groups.")},
		{"get_data_ptr",           (PyCFunction)CbEmpiricalHceHeatLoss_get_data_ptr,  METH_VARARGS,
				PyDoc_STR("get_data_ptr() -> Pointer\n Get ssc_data_t pointer")},
		{"set_data_ptr",           (PyCFunction)CbEmpiricalHceHeatLoss_set_data_ptr,  METH_VARARGS,
...
CbEmpiricalHceHeatLoss_default(PyObject *self, PyObject *args)
{
	...
	rv->data_owner_ptr = NULL;
	if (PySAM_load_defaults((PyObject*)rv, rv->x_attr, rv->data_ptr, "CbEmpiricalHceHeatLoss", def) < 0) {
		CbEmpiricalHceHeatLoss_dealloc(rv);
		return NULL;
	}
	return (PyObject *)rv;
}
