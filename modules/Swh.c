...
static PyObject *
Swh_set_data_ptr(CmodObject *self, PyObject *args)
{
	...
	VarGroupObject* SWH_obj = (VarGroupObject*)PyDict_GetItemString(self->x_attr, "SWH");
	SWH_obj->data_ptr = (void*)ptr;
...
static PyMethodDef Swh_methods[] = {
		...
		{"set_data_ptr",           (PyCFunction)Swh_set_data_ptr,  METH_VARARGS,
