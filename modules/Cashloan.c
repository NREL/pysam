...
{
	return PySAM_double_getter(SAM_Cashloan_FinancialParameters_batt_salvage_percentage_nget, self->data_ptr);
}

static int
FinancialParameters_set_batt_salvage_percentage(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_double_setter(value, SAM_Cashloan_FinancialParameters_batt_salvage_percentage_nset, self->data_ptr);
}
...
{
	return PySAM_array_getter(SAM_Cashloan_Battery_batt_annual_charge_from_system_aget, self->data_ptr);
}

static int
Battery_set_batt_annual_charge_from_system(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_Cashloan_Battery_batt_annual_charge_from_system_aset, self->data_ptr);
}

static PyObject *
Battery_get_batt_annual_discharge_energy(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Cashloan_Battery_batt_annual_discharge_energy_aget, self->data_ptr);
}

static int
Battery_set_batt_annual_discharge_energy(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_Cashloan_Battery_batt_annual_discharge_energy_aset, self->data_ptr);
}
...
{
	return PySAM_double_getter(SAM_Cashloan_Battery_battery_total_cost_lcos_nget, self->data_ptr);
}

static int
Battery_set_battery_total_cost_lcos(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_double_setter(value, SAM_Cashloan_Battery_battery_total_cost_lcos_nset, self->data_ptr);
}

static PyObject *
Battery_get_grid_to_batt(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Cashloan_Battery_grid_to_batt_aget, self->data_ptr);
}

static int
Battery_set_grid_to_batt(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_Cashloan_Battery_grid_to_batt_aset, self->data_ptr);
}
...
{
	return PySAM_array_getter(SAM_Cashloan_Battery_monthly_system_to_grid_aget, self->data_ptr);
}

static int
Battery_set_monthly_system_to_grid(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_Cashloan_Battery_monthly_system_to_grid_aset, self->data_ptr);
}
...
{
	return PySAM_array_getter(SAM_Cashloan_ChargesByMonth_year1_monthly_ec_charge_with_system_aget, self->data_ptr);
}

static int
ChargesByMonth_set_year1_monthly_ec_charge_with_system(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_Cashloan_ChargesByMonth_year1_monthly_ec_charge_with_system_aset, self->data_ptr);
}
...
static PyObject *
Monthly_new(SAM_Cashloan data_ptr)
{
...
Monthly_assign(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_assign_from_dict(self->data_ptr, dict, "Cashloan", "Monthly")){
		return NULL;
	}
...
Monthly_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Cashloan", "Monthly")){
		return NULL;
	}
...
{
	return PySAM_array_getter(SAM_Cashloan_Monthly_year1_monthly_ec_charge_gross_with_system_aget, self->data_ptr);
}

static int
Monthly_set_year1_monthly_ec_charge_gross_with_system(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_Cashloan_Monthly_year1_monthly_ec_charge_gross_with_system_aset, self->data_ptr);
}

static PyObject *
Monthly_get_year1_monthly_electricity_to_grid(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Cashloan_Monthly_year1_monthly_electricity_to_grid_aget, self->data_ptr);
}

static int
Monthly_set_year1_monthly_electricity_to_grid(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_Cashloan_Monthly_year1_monthly_electricity_to_grid_aset, self->data_ptr);
}
...
{
	return PySAM_array_getter(SAM_Cashloan_Outputs_cf_batt_replacement_cost_aget, self->data_ptr);
}
...
CashloanModule_exec(PyObject *m)
{
	...
	/// Add the Monthly type object to Cashloan_Type
