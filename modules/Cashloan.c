...
static PyObject *
Cashloan_set_data_ptr(CmodObject *self, PyObject *args)
{
	...
	VarGroupObject* ThirdPartyOwnership_obj = (VarGroupObject*)PyDict_GetItemString(self->x_attr, "ThirdPartyOwnership");
	ThirdPartyOwnership_obj->data_ptr = (void*)ptr;
...
static PyMethodDef Cashloan_methods[] = {
		...
		{"set_data_ptr",           (PyCFunction)Cashloan_set_data_ptr,  METH_VARARGS,
