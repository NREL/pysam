...
{
	return PySAM_double_getter(SAM_Utilityrate3_Outputs_utility_bill_w_sys_year1_nget, self->data_ptr);
}
...
{
	return PySAM_double_getter(SAM_Utilityrate3_Outputs_utility_bill_wo_sys_year1_nget, self->data_ptr);
}
