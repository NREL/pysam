...
static PyObject *
Pv6parmod_get_data_ptr(CmodObject *self, PyObject *args)
{
...
static PyObject *
Pv6parmod_set_data_ptr(CmodObject *self, PyObject *args)
{
	...
	VarGroupObject* CEC6ParameterPVModuleModel_obj = (VarGroupObject*)PyDict_GetItemString(self->x_attr, "CEC6ParameterPVModuleModel");
	CEC6ParameterPVModuleModel_obj->data_ptr = (void*)ptr;
...
static PyMethodDef Pv6parmod_methods[] = {
		...
		{"get_data_ptr",           (PyCFunction)Pv6parmod_get_data_ptr,  METH_VARARGS,
				PyDoc_STR("get_data_ptr() -> Pointer\n Get ssc_data_t pointer")},
		{"set_data_ptr",           (PyCFunction)Pv6parmod_set_data_ptr,  METH_VARARGS,
