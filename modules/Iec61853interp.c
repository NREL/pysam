...
static PyObject *
IEC61853_replace(VarGroupObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Iec61853interp", "IEC61853")){
		return NULL;
	}
...
SingleDiodeModel_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Iec61853interp", "SingleDiodeModel")){
		return NULL;
	}
...
Outputs_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Iec61853interp", "Outputs")){
		return NULL;
	}
...
static PyObject *
Iec61853interp_get_data_ptr(CmodObject *self, PyObject *args)
{
...
static PyObject *
Iec61853interp_replace(CmodObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_replace_from_nested_dict((PyObject*)self, self->x_attr, self->data_ptr, dict, "Iec61853interp"))
		return NULL;
...
static PyObject *
Iec61853interp_unassign(CmodObject *self, PyObject *args)
{
...
static PyMethodDef Iec61853interp_methods[] = {
		...
		{"unassign",          (PyCFunction)Iec61853interp_unassign, METH_VARARGS,
