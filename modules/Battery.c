...
static PyObject *
Battery_set_data_ptr(CmodObject *self, PyObject *args)
{
	...
	VarGroupObject* Simulation_obj = (VarGroupObject*)PyDict_GetItemString(self->x_attr, "Simulation");
	Simulation_obj->data_ptr = (void*)ptr;
