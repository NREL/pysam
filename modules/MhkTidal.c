...
static PyObject *
MhkTidal_set_data_ptr(CmodObject *self, PyObject *args)
{
	...
	VarGroupObject* MHKTidal_obj = (VarGroupObject*)PyDict_GetItemString(self->x_attr, "MHKTidal");
	MHKTidal_obj->data_ptr = (void*)ptr;
...
static PyMethodDef MhkTidal_methods[] = {
		...
		{"set_data_ptr",           (PyCFunction)MhkTidal_set_data_ptr,  METH_VARARGS,
