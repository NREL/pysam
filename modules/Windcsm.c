...
static PyObject *
WindCsm_replace(VarGroupObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Windcsm", "WindCsm")){
		return NULL;
	}
...
Outputs_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Windcsm", "Outputs")){
		return NULL;
	}
...
static PyObject *
Windcsm_set_data_ptr(CmodObject *self, PyObject *args)
{
	...
	VarGroupObject* WindCsm_obj = (VarGroupObject*)PyDict_GetItemString(self->x_attr, "WindCsm");
	WindCsm_obj->data_ptr = (void*)ptr;
...
static PyObject *
Windcsm_replace(CmodObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_replace_from_nested_dict((PyObject*)self, self->x_attr, self->data_ptr, dict, "Windcsm"))
		return NULL;
...
static PyObject *
Windcsm_unassign(CmodObject *self, PyObject *args)
{
...
static PyMethodDef Windcsm_methods[] = {
		...
		{"set_data_ptr",           (PyCFunction)Windcsm_set_data_ptr,  METH_VARARGS,
		...
		{"unassign",          (PyCFunction)Windcsm_unassign, METH_VARARGS,
