...
static PyObject *
UiTesCalcs_set_data_ptr(CmodObject *self, PyObject *args)
{
...
static PyObject *
UiTesCalcs_unassign(CmodObject *self, PyObject *args)
{
...
static PyMethodDef UiTesCalcs_methods[] = {
		...
		{"set_data_ptr",           (PyCFunction)UiTesCalcs_set_data_ptr,  METH_VARARGS,
