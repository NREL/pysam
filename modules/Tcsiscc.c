...
Weather_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Tcsiscc", "Weather")){
		return NULL;
	}
...
static PyObject *
MoltenSaltTower_replace(VarGroupObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Tcsiscc", "MoltenSaltTower")){
		return NULL;
	}
...
static PyMethodDef MoltenSaltTower_methods[] = {
		...
		{"replace",            (PyCFunction)MoltenSaltTower_replace,  METH_VARARGS,
			PyDoc_STR("replace(dict) -> None\n Replace attributes from dictionary, unassigning values not present in input dict\n\n``MoltenSaltTower_vals = { var: val, ...}``")},
...
Heliostat_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Tcsiscc", "Heliostat")){
		return NULL;
	}
...
Receiver_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Tcsiscc", "Receiver")){
		return NULL;
	}
...
Powerblock_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Tcsiscc", "Powerblock")){
		return NULL;
	}
...
Parasitics_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Tcsiscc", "Parasitics")){
		return NULL;
	}
...
Outputs_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Tcsiscc", "Outputs")){
		return NULL;
	}
...
{
	return PySAM_matrix_getter(SAM_Tcsiscc_Outputs_annual_energy_distribution_time_mget, self->data_ptr);
}
...
static PyObject *
Tcsiscc_replace(CmodObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_replace_from_nested_dict((PyObject*)self, self->x_attr, self->data_ptr, dict, "Tcsiscc"))
		return NULL;
...
static PyObject *
Tcsiscc_unassign(CmodObject *self, PyObject *args)
{
...
static PyMethodDef Tcsiscc_methods[] = {
		...
		{"replace",            (PyCFunction)Tcsiscc_replace,  METH_VARARGS,
		...
		{"unassign",          (PyCFunction)Tcsiscc_unassign, METH_VARARGS,
