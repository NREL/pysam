...
PVWatts_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Pvwattsv51ts", "PVWatts")){
		return NULL;
	}
...
SystemDesign_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Pvwattsv51ts", "SystemDesign")){
		return NULL;
	}
...
Outputs_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Pvwattsv51ts", "Outputs")){
		return NULL;
	}
...
static PyObject *
Pvwattsv51ts_set_data_ptr(CmodObject *self, PyObject *args)
{
...
static PyObject *
Pvwattsv51ts_replace(CmodObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_replace_from_nested_dict((PyObject*)self, self->x_attr, self->data_ptr, dict, "Pvwattsv51ts"))
		return NULL;
...
static PyObject *
Pvwattsv51ts_unassign(CmodObject *self, PyObject *args)
{
...
static PyMethodDef Pvwattsv51ts_methods[] = {
		...
		{"replace",            (PyCFunction)Pvwattsv51ts_replace,  METH_VARARGS,
		...
		{"set_data_ptr",           (PyCFunction)Pvwattsv51ts_set_data_ptr,  METH_VARARGS,
...
Pvwattsv51ts_default(PyObject *self, PyObject *args)
{
	...
	rv->data_owner_ptr = NULL;
	if (PySAM_load_defaults((PyObject*)rv, rv->x_attr, rv->data_ptr, "Pvwattsv51ts", def) < 0) {
		Pvwattsv51ts_dealloc(rv);
		return NULL;
	}
	return (PyObject *)rv;
}
