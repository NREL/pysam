...
WeatherReader_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "WindFileReader", "WeatherReader")){
		return NULL;
	}
...
Outputs_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "WindFileReader", "Outputs")){
		return NULL;
	}
...
static PyObject *
WindFileReader_get_data_ptr(CmodObject *self, PyObject *args)
{
...
static PyObject *
WindFileReader_set_data_ptr(CmodObject *self, PyObject *args)
{
	...
	VarGroupObject* WeatherReader_obj = (VarGroupObject*)PyDict_GetItemString(self->x_attr, "WeatherReader");
	WeatherReader_obj->data_ptr = (void*)ptr;
...
static PyObject *
WindFileReader_replace(CmodObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_replace_from_nested_dict((PyObject*)self, self->x_attr, self->data_ptr, dict, "WindFileReader"))
		return NULL;
...
static PyObject *
WindFileReader_unassign(CmodObject *self, PyObject *args)
{
...
static PyMethodDef WindFileReader_methods[] = {
		...
		{"replace",            (PyCFunction)WindFileReader_replace,  METH_VARARGS,
		...
		{"unassign",          (PyCFunction)WindFileReader_unassign, METH_VARARGS,
				PyDoc_STR("unassign(name) -> None\n Unassign a value in any of the variable groups.")},
		{"get_data_ptr",           (PyCFunction)WindFileReader_get_data_ptr,  METH_VARARGS,
				PyDoc_STR("get_data_ptr() -> Pointer\n Get ssc_data_t pointer")},
		{"set_data_ptr",           (PyCFunction)WindFileReader_set_data_ptr,  METH_VARARGS,
