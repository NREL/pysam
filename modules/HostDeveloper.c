...
{
	return PySAM_double_getter(SAM_HostDeveloper_FinancialParameters_batt_salvage_percentage_nget, self->data_ptr);
}

static int
FinancialParameters_set_batt_salvage_percentage(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_double_setter(value, SAM_HostDeveloper_FinancialParameters_batt_salvage_percentage_nset, self->data_ptr);
}
...
{
	return PySAM_double_getter(SAM_HostDeveloper_SystemCosts_ui_batt_capacity_nget, self->data_ptr);
}

static int
SystemCosts_set_ui_batt_capacity(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_double_setter(value, SAM_HostDeveloper_SystemCosts_ui_batt_capacity_nset, self->data_ptr);
}

static PyObject *
SystemCosts_get_ui_fuelcell_capacity(VarGroupObject *self, void *closure)
{
	return PySAM_double_getter(SAM_HostDeveloper_SystemCosts_ui_fuelcell_capacity_nget, self->data_ptr);
}

static int
SystemCosts_set_ui_fuelcell_capacity(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_double_setter(value, SAM_HostDeveloper_SystemCosts_ui_fuelcell_capacity_nset, self->data_ptr);
}
...
ReturnOnEquity_new(SAM_HostDeveloper data_ptr)
{
	...
	VarGroupObject* ReturnOnEquity_obj = (VarGroupObject*)new_obj;

	ReturnOnEquity_obj->data_ptr = (SAM_table)data_ptr;
...
static PyObject *
ReturnOnEquity_assign(VarGroupObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
...
static PyObject *
ReturnOnEquity_replace(VarGroupObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "HostDeveloper", "ReturnOnEquity")){
		return NULL;
	}
...
static PyObject *
ReturnOnEquity_export(VarGroupObject *self, PyObject *args)
{
	PyTypeObject* tp = &ReturnOnEquity_Type;
	PyObject* dict = PySAM_export_to_dict((PyObject *) self, tp);
	return dict;
...
static PyMethodDef ReturnOnEquity_methods[] = {
		...
		{"replace",            (PyCFunction)ReturnOnEquity_replace,  METH_VARARGS,
			PyDoc_STR("replace(dict) -> None\n Replace attributes from dictionary, unassigning values not present in input dict\n\n``ReturnOnEquity_vals = { var: val, ...}``")},
...
static PyObject *
ReturnOnEquity_get_roe_input(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_HostDeveloper_ReturnOnEquity_roe_input_aget, self->data_ptr);
}

static int
ReturnOnEquity_set_roe_input(VarGroupObject *self, PyObject *value, void *closure)
{
...
Battery_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "HostDeveloper", "Battery")){
		return NULL;
	}
...
{
	return PySAM_array_getter(SAM_HostDeveloper_Battery_batt_annual_charge_from_system_aget, self->data_ptr);
}

static int
Battery_set_batt_annual_charge_from_system(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_HostDeveloper_Battery_batt_annual_charge_from_system_aset, self->data_ptr);
}

static PyObject *
Battery_get_batt_annual_discharge_energy(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_HostDeveloper_Battery_batt_annual_discharge_energy_aget, self->data_ptr);
}

static int
Battery_set_batt_annual_discharge_energy(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_HostDeveloper_Battery_batt_annual_discharge_energy_aset, self->data_ptr);
}

static PyObject *
Battery_get_batt_capacity_percent(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_HostDeveloper_Battery_batt_capacity_percent_aget, self->data_ptr);
}

static int
Battery_set_batt_capacity_percent(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_HostDeveloper_Battery_batt_capacity_percent_aset, self->data_ptr);
}

static PyObject *
Battery_get_battery_total_cost_lcos(VarGroupObject *self, void *closure)
{
	return PySAM_double_getter(SAM_HostDeveloper_Battery_battery_total_cost_lcos_nget, self->data_ptr);
}

static int
Battery_set_battery_total_cost_lcos(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_double_setter(value, SAM_HostDeveloper_Battery_battery_total_cost_lcos_nset, self->data_ptr);
}

static PyObject *
Battery_get_grid_to_batt(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_HostDeveloper_Battery_grid_to_batt_aget, self->data_ptr);
}

static int
Battery_set_grid_to_batt(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_HostDeveloper_Battery_grid_to_batt_aset, self->data_ptr);
}

static PyObject *
Battery_get_monthly_batt_to_grid(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_HostDeveloper_Battery_monthly_batt_to_grid_aget, self->data_ptr);
}

static int
Battery_set_monthly_batt_to_grid(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_HostDeveloper_Battery_monthly_batt_to_grid_aset, self->data_ptr);
}

static PyObject *
Battery_get_monthly_grid_to_batt(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_HostDeveloper_Battery_monthly_grid_to_batt_aget, self->data_ptr);
}

static int
Battery_set_monthly_grid_to_batt(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_HostDeveloper_Battery_monthly_grid_to_batt_aset, self->data_ptr);
}

static PyObject *
Battery_get_monthly_grid_to_load(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_HostDeveloper_Battery_monthly_grid_to_load_aget, self->data_ptr);
}

static int
Battery_set_monthly_grid_to_load(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_HostDeveloper_Battery_monthly_grid_to_load_aset, self->data_ptr);
}

static PyObject *
Battery_get_monthly_system_to_grid(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_HostDeveloper_Battery_monthly_system_to_grid_aget, self->data_ptr);
}

static int
Battery_set_monthly_system_to_grid(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_HostDeveloper_Battery_monthly_system_to_grid_aset, self->data_ptr);
}
...
{
	return PySAM_array_getter(SAM_HostDeveloper_ChargesByMonth_year1_monthly_ec_charge_with_system_aget, self->data_ptr);
}

static int
ChargesByMonth_set_year1_monthly_ec_charge_with_system(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_HostDeveloper_ChargesByMonth_year1_monthly_ec_charge_with_system_aset, self->data_ptr);
}
...
{
	return PySAM_array_getter(SAM_HostDeveloper_Monthly_year1_monthly_ec_charge_gross_with_system_aget, self->data_ptr);
}

static int
Monthly_set_year1_monthly_ec_charge_gross_with_system(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_HostDeveloper_Monthly_year1_monthly_ec_charge_gross_with_system_aset, self->data_ptr);
}

static PyObject *
Monthly_get_year1_monthly_electricity_to_grid(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_HostDeveloper_Monthly_year1_monthly_electricity_to_grid_aget, self->data_ptr);
}

static int
Monthly_set_year1_monthly_electricity_to_grid(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_HostDeveloper_Monthly_year1_monthly_electricity_to_grid_aset, self->data_ptr);
}
...
{
	return PySAM_array_getter(SAM_HostDeveloper_Outputs_cf_batt_replacement_cost_aget, self->data_ptr);
}
...
{
	return PySAM_array_getter(SAM_HostDeveloper_Outputs_cf_om_batt_production_expense_aget, self->data_ptr);
}
...
{
	return PySAM_array_getter(SAM_HostDeveloper_Outputs_cf_ptc_total_aget, self->data_ptr);
}
