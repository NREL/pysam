...
{
	return PySAM_double_getter(SAM_HostDeveloper_HybridCosts_land_area_nget, self->data_ptr);
}

static int
HybridCosts_set_land_area(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_double_setter(value, SAM_HostDeveloper_HybridCosts_land_area_nset, self->data_ptr);
}

static PyObject *
HybridCosts_get_om_capacity(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_HostDeveloper_HybridCosts_om_capacity_aget, self->data_ptr);
}

static int
HybridCosts_set_om_capacity(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_HostDeveloper_HybridCosts_om_capacity_aset, self->data_ptr);
}

static PyObject *
HybridCosts_get_om_capacity_escal(VarGroupObject *self, void *closure)
{
	return PySAM_double_getter(SAM_HostDeveloper_HybridCosts_om_capacity_escal_nget, self->data_ptr);
}

static int
HybridCosts_set_om_capacity_escal(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_double_setter(value, SAM_HostDeveloper_HybridCosts_om_capacity_escal_nset, self->data_ptr);
}

static PyObject *
HybridCosts_get_om_fixed(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_HostDeveloper_HybridCosts_om_fixed_aget, self->data_ptr);
}

static int
HybridCosts_set_om_fixed(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_HostDeveloper_HybridCosts_om_fixed_aset, self->data_ptr);
}

static PyObject *
HybridCosts_get_om_fixed_escal(VarGroupObject *self, void *closure)
{
	return PySAM_double_getter(SAM_HostDeveloper_HybridCosts_om_fixed_escal_nget, self->data_ptr);
}

static int
HybridCosts_set_om_fixed_escal(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_double_setter(value, SAM_HostDeveloper_HybridCosts_om_fixed_escal_nset, self->data_ptr);
}

static PyObject *
HybridCosts_get_om_land_lease(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_HostDeveloper_HybridCosts_om_land_lease_aget, self->data_ptr);
}

static int
HybridCosts_set_om_land_lease(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_HostDeveloper_HybridCosts_om_land_lease_aset, self->data_ptr);
}

static PyObject *
HybridCosts_get_om_land_lease_escal(VarGroupObject *self, void *closure)
{
	return PySAM_double_getter(SAM_HostDeveloper_HybridCosts_om_land_lease_escal_nget, self->data_ptr);
}

static int
HybridCosts_set_om_land_lease_escal(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_double_setter(value, SAM_HostDeveloper_HybridCosts_om_land_lease_escal_nset, self->data_ptr);
}

static PyObject *
HybridCosts_get_om_production(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_HostDeveloper_HybridCosts_om_production_aget, self->data_ptr);
}

static int
HybridCosts_set_om_production(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_HostDeveloper_HybridCosts_om_production_aset, self->data_ptr);
}

static PyObject *
HybridCosts_get_om_production_escal(VarGroupObject *self, void *closure)
{
	return PySAM_double_getter(SAM_HostDeveloper_HybridCosts_om_production_escal_nget, self->data_ptr);
}

static int
HybridCosts_set_om_production_escal(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_double_setter(value, SAM_HostDeveloper_HybridCosts_om_production_escal_nset, self->data_ptr);
}
...
static PyObject *
HostDeveloper_set_data_ptr(CmodObject *self, PyObject *args)
{
	...
	VarGroupObject* Host_obj = (VarGroupObject*)PyDict_GetItemString(self->x_attr, "Host");
	Host_obj->data_ptr = (void*)ptr;
...
static PyMethodDef HostDeveloper_methods[] = {
		...
		{"set_data_ptr",           (PyCFunction)HostDeveloper_set_data_ptr,  METH_VARARGS,
