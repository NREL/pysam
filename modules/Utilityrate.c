...
Common_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Utilityrate", "Common")){
		return NULL;
	}
...
Outputs_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Utilityrate", "Outputs")){
		return NULL;
	}
...
static PyObject *
Utilityrate_get_data_ptr(CmodObject *self, PyObject *args)
{
...
static PyObject *
Utilityrate_set_data_ptr(CmodObject *self, PyObject *args)
{
...
static PyObject *
Utilityrate_replace(CmodObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_replace_from_nested_dict((PyObject*)self, self->x_attr, self->data_ptr, dict, "Utilityrate"))
		return NULL;
...
static PyObject *
Utilityrate_unassign(CmodObject *self, PyObject *args)
{
...
static PyMethodDef Utilityrate_methods[] = {
		...
		{"replace",            (PyCFunction)Utilityrate_replace,  METH_VARARGS,
		...
		{"unassign",          (PyCFunction)Utilityrate_unassign, METH_VARARGS,
				PyDoc_STR("unassign(name) -> None\n Unassign a value in any of the variable groups.")},
		{"get_data_ptr",           (PyCFunction)Utilityrate_get_data_ptr,  METH_VARARGS,
				PyDoc_STR("get_data_ptr() -> Pointer\n Get ssc_data_t pointer")},
		{"set_data_ptr",           (PyCFunction)Utilityrate_set_data_ptr,  METH_VARARGS,
...
Utilityrate_default(PyObject *self, PyObject *args)
{
	...
	rv->data_owner_ptr = NULL;
	if (PySAM_load_defaults((PyObject*)rv, rv->x_attr, rv->data_ptr, "Utilityrate", def) < 0) {
		Utilityrate_dealloc(rv);
		return NULL;
	}
	return (PyObject *)rv;
}
