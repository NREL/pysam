...
static PyObject *
WeatherFileChecker_replace(VarGroupObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Wfcheck", "WeatherFileChecker")){
		return NULL;
	}
...
static PyObject *
Wfcheck_get_data_ptr(CmodObject *self, PyObject *args)
{
...
static PyObject *
Wfcheck_set_data_ptr(CmodObject *self, PyObject *args)
{
	...
	VarGroupObject* WeatherFileChecker_obj = (VarGroupObject*)PyDict_GetItemString(self->x_attr, "WeatherFileChecker");
	WeatherFileChecker_obj->data_ptr = (void*)ptr;
	return Py_None;
}
...
static PyObject *
Wfcheck_replace(CmodObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_replace_from_nested_dict((PyObject*)self, self->x_attr, self->data_ptr, dict, "Wfcheck"))
		return NULL;
...
static PyObject *
Wfcheck_unassign(CmodObject *self, PyObject *args)
{
...
static PyMethodDef Wfcheck_methods[] = {
		...
		{"get_data_ptr",           (PyCFunction)Wfcheck_get_data_ptr,  METH_VARARGS,
				PyDoc_STR("get_data_ptr() -> Pointer\n Get ssc_data_t pointer")},
		{"set_data_ptr",           (PyCFunction)Wfcheck_set_data_ptr,  METH_VARARGS,
		...
		{"replace",            (PyCFunction)Wfcheck_replace,  METH_VARARGS,
		...
		{"unassign",          (PyCFunction)Wfcheck_unassign, METH_VARARGS,
...
Wfcheck_default(PyObject *self, PyObject *args)
{
	...
	rv->data_owner_ptr = NULL;
	if (PySAM_load_defaults((PyObject*)rv, rv->x_attr, rv->data_ptr, "Wfcheck", def) < 0) {
		Wfcheck_dealloc(rv);
		return NULL;
	}
	return (PyObject *)rv;
