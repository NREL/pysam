...
static PyObject *
Outputs_new(SAM_Wfcheck data_ptr)
{
...
Outputs_assign(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_assign_from_dict(self->data_ptr, dict, "Wfcheck", "Outputs")){
		return NULL;
	}
...
newWfcheckObject(void* data_ptr)
{
	...
	PySAM_TECH_ATTR("Wfcheck", SAM_Wfcheck_construct)
...
Wfcheck_dealloc(CmodObject *self)
{
	...
	if (!self->data_owner_ptr)
		SAM_Wfcheck_destruct(self->data_ptr);
	PyObject_Del(self);
}
...
WfcheckModule_exec(PyObject *m)
{
	...
	/// Add the Outputs type object to Wfcheck_Type
