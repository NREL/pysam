...
{
	return PySAM_double_getter(SAM_Equpartflip_SystemCosts_ui_batt_capacity_nget, self->data_ptr);
}

static int
SystemCosts_set_ui_batt_capacity(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_double_setter(value, SAM_Equpartflip_SystemCosts_ui_batt_capacity_nset, self->data_ptr);
}

static PyObject *
SystemCosts_get_ui_fuelcell_capacity(VarGroupObject *self, void *closure)
{
	return PySAM_double_getter(SAM_Equpartflip_SystemCosts_ui_fuelcell_capacity_nget, self->data_ptr);
}

static int
SystemCosts_set_ui_fuelcell_capacity(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_double_setter(value, SAM_Equpartflip_SystemCosts_ui_fuelcell_capacity_nset, self->data_ptr);
}
