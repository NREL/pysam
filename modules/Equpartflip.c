...
static PyObject *
FuelCell_new(SAM_Equpartflip data_ptr)
{
...
FuelCell_assign(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_assign_from_dict(self->data_ptr, dict, "Equpartflip", "FuelCell")){
		return NULL;
	}
...
FuelCell_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Equpartflip", "FuelCell")){
		return NULL;
	}
...
{
	return PySAM_array_getter(SAM_Equpartflip_FuelCell_annual_fuel_usage_lifetime_aget, self->data_ptr);
}

static int
FuelCell_set_annual_fuel_usage_lifetime(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_Equpartflip_FuelCell_annual_fuel_usage_lifetime_aset, self->data_ptr);
}

static PyObject *
FuelCell_get_fuelcell_annual_energy_discharged(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_FuelCell_fuelcell_annual_energy_discharged_aget, self->data_ptr);
}

static int
FuelCell_set_fuelcell_annual_energy_discharged(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_Equpartflip_FuelCell_fuelcell_annual_energy_discharged_aset, self->data_ptr);
}

static PyObject *
FuelCell_get_fuelcell_replacement(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_FuelCell_fuelcell_replacement_aget, self->data_ptr);
}

static int
FuelCell_set_fuelcell_replacement(VarGroupObject *self, PyObject *value, void *closure)
{
	return PySAM_array_setter(value, SAM_Equpartflip_FuelCell_fuelcell_replacement_aset, self->data_ptr);
}
...
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_apr_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_aug(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_aug_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_dec(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_dec_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_dispatch1(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_dispatch1_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_dispatch2(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_dispatch2_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_dispatch3(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_dispatch3_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_dispatch4(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_dispatch4_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_dispatch5(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_dispatch5_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_dispatch6(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_dispatch6_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_dispatch7(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_dispatch7_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_dispatch8(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_dispatch8_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_dispatch9(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_dispatch9_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_feb(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_feb_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_jan(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_jan_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_jul(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_jul_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_jun(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_jun_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_mar(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_mar_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_may(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_may_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_monthly_firstyear_TOD1(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_monthly_firstyear_TOD1_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_monthly_firstyear_TOD2(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_monthly_firstyear_TOD2_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_monthly_firstyear_TOD3(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_monthly_firstyear_TOD3_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_monthly_firstyear_TOD4(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_monthly_firstyear_TOD4_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_monthly_firstyear_TOD5(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_monthly_firstyear_TOD5_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_monthly_firstyear_TOD6(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_monthly_firstyear_TOD6_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_monthly_firstyear_TOD7(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_monthly_firstyear_TOD7_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_monthly_firstyear_TOD8(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_monthly_firstyear_TOD8_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_monthly_firstyear_TOD9(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_monthly_firstyear_TOD9_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_nov(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_nov_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_oct(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_oct_aget, self->data_ptr);
}

static PyObject *
Outputs_get_cf_energy_sales_sep(VarGroupObject *self, void *closure)
{
	return PySAM_array_getter(SAM_Equpartflip_Outputs_cf_energy_sales_sep_aget, self->data_ptr);
}
...
static PyObject *
Equpartflip_get_data_ptr(CmodObject *self, PyObject *args)
{
...
static PyObject *
Equpartflip_set_data_ptr(CmodObject *self, PyObject *args)
{
	...
	VarGroupObject* DeveloperCapitalRecovery_obj = (VarGroupObject*)PyDict_GetItemString(self->x_attr, "DeveloperCapitalRecovery");
	DeveloperCapitalRecovery_obj->data_ptr = (void*)ptr;
...
static PyMethodDef Equpartflip_methods[] = {
		...
		{"get_data_ptr",           (PyCFunction)Equpartflip_get_data_ptr,  METH_VARARGS,
				PyDoc_STR("get_data_ptr() -> Pointer\n Get ssc_data_t pointer")},
		{"set_data_ptr",           (PyCFunction)Equpartflip_set_data_ptr,  METH_VARARGS,
...
EqupartflipModule_exec(PyObject *m)
{
	...
	/// Add the FuelCell type object to Equpartflip_Type
