...
static PyObject *
Thermalrate_set_data_ptr(CmodObject *self, PyObject *args)
{
	...
	VarGroupObject* ThermalRate_obj = (VarGroupObject*)PyDict_GetItemString(self->x_attr, "ThermalRate");
	ThermalRate_obj->data_ptr = (void*)ptr;
...
static PyMethodDef Thermalrate_methods[] = {
		...
		{"set_data_ptr",           (PyCFunction)Thermalrate_set_data_ptr,  METH_VARARGS,
