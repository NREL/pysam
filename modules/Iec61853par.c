...
IEC61853_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Iec61853par", "IEC61853")){
		return NULL;
	}
...
Outputs_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Iec61853par", "Outputs")){
		return NULL;
	}
...
static PyObject *
Iec61853par_set_data_ptr(CmodObject *self, PyObject *args)
{
...
static PyObject *
Iec61853par_replace(CmodObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_replace_from_nested_dict((PyObject*)self, self->x_attr, self->data_ptr, dict, "Iec61853par"))
		return NULL;
...
static PyObject *
Iec61853par_unassign(CmodObject *self, PyObject *args)
{
...
static PyMethodDef Iec61853par_methods[] = {
		...
		{"set_data_ptr",           (PyCFunction)Iec61853par_set_data_ptr,  METH_VARARGS,
		...
		{"unassign",          (PyCFunction)Iec61853par_unassign, METH_VARARGS,
