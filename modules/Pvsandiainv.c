...
static PyObject *
SandiaInverterModel_replace(VarGroupObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Pvsandiainv", "SandiaInverterModel")){
		return NULL;
	}
...
Outputs_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Pvsandiainv", "Outputs")){
		return NULL;
	}
...
static PyObject *
Pvsandiainv_set_data_ptr(CmodObject *self, PyObject *args)
{
	...
	VarGroupObject* SandiaInverterModel_obj = (VarGroupObject*)PyDict_GetItemString(self->x_attr, "SandiaInverterModel");
	SandiaInverterModel_obj->data_ptr = (void*)ptr;
...
static PyObject *
Pvsandiainv_replace(CmodObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_replace_from_nested_dict((PyObject*)self, self->x_attr, self->data_ptr, dict, "Pvsandiainv"))
		return NULL;
...
static PyObject *
Pvsandiainv_unassign(CmodObject *self, PyObject *args)
{
...
static PyMethodDef Pvsandiainv_methods[] = {
		...
		{"set_data_ptr",           (PyCFunction)Pvsandiainv_set_data_ptr,  METH_VARARGS,
