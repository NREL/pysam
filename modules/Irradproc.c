...
static PyObject *
Irradproc_set_data_ptr(CmodObject *self, PyObject *args)
{
	...
	VarGroupObject* IrradianceProcessor_obj = (VarGroupObject*)PyDict_GetItemString(self->x_attr, "IrradianceProcessor");
	IrradianceProcessor_obj->data_ptr = (void*)ptr;
...
static PyMethodDef Irradproc_methods[] = {
		...
		{"set_data_ptr",           (PyCFunction)Irradproc_set_data_ptr,  METH_VARARGS,
