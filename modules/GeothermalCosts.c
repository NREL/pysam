...
static PyObject *
GeothermalCosts_set_data_ptr(CmodObject *self, PyObject *args)
{
	...
	VarGroupObject* GeoHourly_obj = (VarGroupObject*)PyDict_GetItemString(self->x_attr, "GeoHourly");
	GeoHourly_obj->data_ptr = (void*)ptr;
...
static PyMethodDef GeothermalCosts_methods[] = {
		...
		{"set_data_ptr",           (PyCFunction)GeothermalCosts_set_data_ptr,  METH_VARARGS,
