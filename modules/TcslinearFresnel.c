...
static PyObject *
TcslinearFresnel_set_data_ptr(CmodObject *self, PyObject *args)
{
	...
	VarGroupObject* LinearFresnelr_obj = (VarGroupObject*)PyDict_GetItemString(self->x_attr, "LinearFresnelr");
	LinearFresnelr_obj->data_ptr = (void*)ptr;
...
static PyMethodDef TcslinearFresnel_methods[] = {
		...
		{"set_data_ptr",           (PyCFunction)TcslinearFresnel_set_data_ptr,  METH_VARARGS,
