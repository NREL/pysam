...
static PyObject *
Sco2CspUdPcTables_set_data_ptr(CmodObject *self, PyObject *args)
{
	...
	VarGroupObject* HeatExchangerDesign_obj = (VarGroupObject*)PyDict_GetItemString(self->x_attr, "HeatExchangerDesign");
	HeatExchangerDesign_obj->data_ptr = (void*)ptr;
	VarGroupObject* Common_obj = (VarGroupObject*)PyDict_GetItemString(self->x_attr, "Common");
	Common_obj->data_ptr = (void*)ptr;
	VarGroupObject* PHXDesign_obj = (VarGroupObject*)PyDict_GetItemString(self->x_attr, "PHXDesign");
	PHXDesign_obj->data_ptr = (void*)ptr;
	VarGroupObject* AirCoolerDesign_obj = (VarGroupObject*)PyDict_GetItemString(self->x_attr, "AirCoolerDesign");
	AirCoolerDesign_obj->data_ptr = (void*)ptr;
...
static PyMethodDef Sco2CspUdPcTables_methods[] = {
		...
		{"set_data_ptr",           (PyCFunction)Sco2CspUdPcTables_set_data_ptr,  METH_VARARGS,
