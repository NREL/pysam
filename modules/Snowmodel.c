...
static PyObject *
PVSnowModel_replace(VarGroupObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Snowmodel", "PVSnowModel")){
		return NULL;
	}
...
TimeSeries_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Snowmodel", "TimeSeries")){
		return NULL;
	}
...
Outputs_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Snowmodel", "Outputs")){
		return NULL;
	}
...
static PyObject *
Snowmodel_set_data_ptr(CmodObject *self, PyObject *args)
{
	...
	VarGroupObject* PVSnowModel_obj = (VarGroupObject*)PyDict_GetItemString(self->x_attr, "PVSnowModel");
	PVSnowModel_obj->data_ptr = (void*)ptr;
...
static PyObject *
Snowmodel_replace(CmodObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_replace_from_nested_dict((PyObject*)self, self->x_attr, self->data_ptr, dict, "Snowmodel"))
		return NULL;
...
static PyObject *
Snowmodel_unassign(CmodObject *self, PyObject *args)
{
...
static PyMethodDef Snowmodel_methods[] = {
		...
		{"set_data_ptr",           (PyCFunction)Snowmodel_set_data_ptr,  METH_VARARGS,
...
Snowmodel_default(PyObject *self, PyObject *args)
{
	...
	rv->data_owner_ptr = NULL;
	if (PySAM_load_defaults((PyObject*)rv, rv->x_attr, rv->data_ptr, "Snowmodel", def) < 0) {
		Snowmodel_dealloc(rv);
		return NULL;
	}
	return (PyObject *)rv;
}
