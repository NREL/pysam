...
SingleDiodeModel_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Singlediode", "SingleDiodeModel")){
		return NULL;
	}
...
Outputs_replace(VarGroupObject *self, PyObject *args)
{
	...
	if (!PySAM_replace_from_dict(tp, self->data_ptr, dict, "Singlediode", "Outputs")){
		return NULL;
	}
...
static PyObject *
Singlediode_get_data_ptr(CmodObject *self, PyObject *args)
{
...
static PyObject *
Singlediode_set_data_ptr(CmodObject *self, PyObject *args)
{
...
static PyObject *
Singlediode_replace(CmodObject *self, PyObject *args)
{
	PyObject* dict;
	if (!PyArg_ParseTuple(args, "O:assign", &dict)){
		return NULL;
	...
	if (!PySAM_replace_from_nested_dict((PyObject*)self, self->x_attr, self->data_ptr, dict, "Singlediode"))
		return NULL;
...
static PyObject *
Singlediode_unassign(CmodObject *self, PyObject *args)
{
...
static PyMethodDef Singlediode_methods[] = {
		...
		{"get_data_ptr",           (PyCFunction)Singlediode_get_data_ptr,  METH_VARARGS,
				PyDoc_STR("get_data_ptr() -> Pointer\n Get ssc_data_t pointer")},
		{"set_data_ptr",           (PyCFunction)Singlediode_set_data_ptr,  METH_VARARGS,
		...
		{"replace",            (PyCFunction)Singlediode_replace,  METH_VARARGS,
		...
		{"unassign",          (PyCFunction)Singlediode_unassign, METH_VARARGS,
