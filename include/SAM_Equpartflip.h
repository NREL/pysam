...
extern "C"
{
	 ...
	 * required if: *
	 */
	SAM_EXPORT void SAM_Equpartflip_Revenue_ppa_price_input_aset(SAM_Equpartflip ptr, double* arr, int length, SAM_error *err);
	 ...
	 * required if: ?=100
	 */
	SAM_EXPORT void SAM_Equpartflip_Revenue_ppa_soln_max_iterations_nset(SAM_Equpartflip ptr, double number, SAM_error *err);
	 ...
	 * required if: ?=0.25
	 */
	SAM_EXPORT void SAM_Equpartflip_FinancialParameters_equip1_reserve_cost_nset(SAM_Equpartflip ptr, double number, SAM_error *err);
	 ...
	 * required if: ?=12
	 */
	SAM_EXPORT void SAM_Equpartflip_FinancialParameters_equip1_reserve_freq_nset(SAM_Equpartflip ptr, double number, SAM_error *err);
	 ...
	 * required if: ?=0
	 */
	SAM_EXPORT void SAM_Equpartflip_FinancialParameters_equip2_reserve_cost_nset(SAM_Equpartflip ptr, double number, SAM_error *err);
	 ...
	 * required if: ?=15
	 */
	SAM_EXPORT void SAM_Equpartflip_FinancialParameters_equip2_reserve_freq_nset(SAM_Equpartflip ptr, double number, SAM_error *err);
	 ...
	 * required if: ?=0
	 */
	SAM_EXPORT void SAM_Equpartflip_FinancialParameters_equip3_reserve_cost_nset(SAM_Equpartflip ptr, double number, SAM_error *err);
	 ...
	 * required if: ?=20
	 */
	SAM_EXPORT void SAM_Equpartflip_FinancialParameters_equip3_reserve_freq_nset(SAM_Equpartflip ptr, double number, SAM_error *err);
	 ...
	 * required if: ?=0
	 */
	SAM_EXPORT void SAM_Equpartflip_FinancialParameters_equip_reserve_depr_fed_nset(SAM_Equpartflip ptr, double number, SAM_error *err);
	 ...
	 * required if: ?=0
	 */
	SAM_EXPORT void SAM_Equpartflip_FinancialParameters_equip_reserve_depr_sta_nset(SAM_Equpartflip ptr, double number, SAM_error *err);
	 ...
	 * required if: ?=1.75
	 */
	SAM_EXPORT void SAM_Equpartflip_FinancialParameters_reserves_interest_nset(SAM_Equpartflip ptr, double number, SAM_error *err);
	 ...
	 * required if: ?=10
	 */
	SAM_EXPORT void SAM_Equpartflip_FinancialParameters_salvage_percentage_nset(SAM_Equpartflip ptr, double number, SAM_error *err);
